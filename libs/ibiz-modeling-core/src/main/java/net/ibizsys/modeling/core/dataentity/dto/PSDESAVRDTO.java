...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSDESAVRID = "psdesavrid";
    public static final String FIELD_PSDESAVRNAME = "PSDESAVRNAME";
    protected static final String DTOFIELD_PSDESAVRNAME = "psdesavrname";
    ...
    @JsonIgnore
    public PSDESAVRDTO codename(String codeName) {
    ...
    @JsonIgnore
    public PSDESAVRDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSDESAVRDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSDESAVRDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }
    ...
    @JsonIgnore
    public PSDESAVRDTO ordervalue(Integer orderValue) {
    ...
    @JsonIgnore
    public PSDESAVRDTO psdefvrid(String pSDEFVRId) {
        this.setPSDEFVRId(pSDEFVRId);
        return this;
    }

    @JsonIgnore
    public PSDESAVRDTO psdefvrid(PSDEFValueRuleDTO pSDEFValueRule) {
    ...
    @JsonIgnore
    public PSDESAVRDTO psdefvrname(String pSDEFVRName) {
    ...
    public void setPSDESAVRId(String pSDESAVRId) {
        this._set(DTOFIELD_PSDESAVRID, pSDESAVRId);
    }

    @JsonIgnore
    public String getPSDESAVRId() {
        Object objValue = this._get(DTOFIELD_PSDESAVRID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDESAVRIdDirty() {
        return this._contains(DTOFIELD_PSDESAVRID);
    }

    @JsonIgnore
    public void resetPSDESAVRId() {
        this._reset(DTOFIELD_PSDESAVRID);
    }

    @JsonIgnore
    public PSDESAVRDTO psdesavrid(String pSDESAVRId) {
    ...
    public void setPSDESAVRName(String pSDESAVRName) {
        this._set(DTOFIELD_PSDESAVRNAME, pSDESAVRName);
    }

    @JsonIgnore
    public String getPSDESAVRName() {
        Object objValue = this._get(DTOFIELD_PSDESAVRNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDESAVRNameDirty() {
        return this._contains(DTOFIELD_PSDESAVRNAME);
    }

    @JsonIgnore
    public void resetPSDESAVRName() {
        this._reset(DTOFIELD_PSDESAVRNAME);
    }

    @JsonIgnore
    public PSDESAVRDTO psdesavrname(String pSDESAVRName) {
    ...
    @JsonIgnore
    public PSDESAVRDTO name(String strName) {
        this.setPSDESAVRName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSDESAVRDTO psdeserviceapiid(String pSDEServiceAPIId) {
        this.setPSDEServiceAPIId(pSDEServiceAPIId);
        return this;
    }

    @JsonIgnore
    public PSDESAVRDTO psdeserviceapiid(PSDEServiceAPIDTO pSDEServiceAPI) {
    ...
    @JsonIgnore
    public PSDESAVRDTO psdeserviceapiname(String pSDEServiceAPIName) {
    ...
    @JsonIgnore
    public PSDESAVRDTO pssysvalueruleid(String pSSysValueRuleId) {
        this.setPSSysValueRuleId(pSSysValueRuleId);
        return this;
    }

    @JsonIgnore
    public PSDESAVRDTO pssysvalueruleid(PSSysValueRuleDTO pSSysValueRule) {
    ...
    @JsonIgnore
    public PSDESAVRDTO pssysvaluerulename(String pSSysValueRuleName) {
    ...
    @JsonIgnore
    public PSDESAVRDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSDESAVRDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSDESAVRDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSDESAVRDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSDESAVRDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSDESAVRDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSDESAVRDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSDESAVRDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSDESAVRDTO validflag(Integer validFlag) {
        this.setValidFlag(validFlag);
        return this;
    }

    @JsonIgnore
    public PSDESAVRDTO validflag(Boolean validFlag) {
        if (validFlag == null) {
    ...
    @JsonIgnore
    public PSDESAVRDTO vrtype(String vRType) {
        this.setVRType(vRType);
        return this;
    }

    @JsonIgnore
    public PSDESAVRDTO vrtype(PSModelEnums.TargetVRType vRType) {
        if (vRType == null) {
            this.setVRType(null);
        } else {
    ...
    @JsonIgnore
    public PSDESAVRDTO id(String strValue) {
        this.setPSDESAVRId(strValue);
        return this;
    }
}
