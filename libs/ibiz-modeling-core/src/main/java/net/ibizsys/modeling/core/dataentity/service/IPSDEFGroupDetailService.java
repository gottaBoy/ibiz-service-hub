...
@Qualifier(value="PSDEFGROUPDETAIL")
public interface IPSDEFGroupDetailService
extends IPSModelDEService<PSDEFGroupDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSDEFGroupDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
