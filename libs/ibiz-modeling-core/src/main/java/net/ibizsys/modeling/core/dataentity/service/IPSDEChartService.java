...
@Qualifier(value="PSDECHART")
public interface IPSDEChartService
extends IPSModelDEService<PSDEChartDTO, ISearchContextDTO> {
    ...
    public Page<PSDEChartDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEChartDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEChartDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEChartDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
