...
public class PSSysPortletCatDTO
extends PSModelDTOBase {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO codename(String codeName) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysPortletCatDTO namepslanresid(String namePSLanResId) {
        this.setNamePSLanResId(namePSLanResId);
        return this;
    }

    @JsonIgnore
    public PSSysPortletCatDTO namepslanresid(PSLanguageResDTO pSLanguageRes) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO namepslanresname(String namePSLanResName) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO psmoduleid(String pSModuleId) {
        this.setPSModuleId(pSModuleId);
        return this;
    }

    @JsonIgnore
    public PSSysPortletCatDTO psmoduleid(PSModuleDTO pSModule) {
        if (pSModule == null) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO psmodulename(String pSModuleName) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO pssyscssid(String pSSysCssId) {
        this.setPSSysCssId(pSSysCssId);
        return this;
    }

    @JsonIgnore
    public PSSysPortletCatDTO pssyscssid(PSSysCssDTO pSSysCss) {
        if (pSSysCss == null) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO pssyscssname(String pSSysCssName) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO pssysimageid(String pSSysImageId) {
        this.setPSSysImageId(pSSysImageId);
        return this;
    }

    @JsonIgnore
    public PSSysPortletCatDTO pssysimageid(PSSysImageDTO pSSysImage) {
        if (pSSysImage == null) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO pssysimagename(String pSSysImageName) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO pssysportletcatid(String pSSysPortletCatId) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO pssysportletcatname(String pSSysPortletCatName) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO name(String strName) {
        this.setPSSysPortletCatName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysPortletCatDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSSysPortletCatDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSSysPortletCatDTO id(String strValue) {
        this.setPSSysPortletCatId(strValue);
        return this;
    }
}
