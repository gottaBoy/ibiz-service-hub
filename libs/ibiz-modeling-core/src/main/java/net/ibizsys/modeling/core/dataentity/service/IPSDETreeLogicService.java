...
@Qualifier(value="PSDETREELOGIC")
public interface IPSDETreeLogicService
extends IPSModelDEService<PSDETreeLogicDTO, ISearchContextDTO> {
    ...
    public Page<PSDETreeLogicDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
