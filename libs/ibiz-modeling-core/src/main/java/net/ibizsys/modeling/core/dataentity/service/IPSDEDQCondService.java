...
@Qualifier(value="PSDEDQCOND")
public interface IPSDEDQCondService
extends IPSModelDEService<PSDEDQCondDTO, ISearchContextDTO> {
    ...
    public static final String DATAQUERY_CURDQROOTCOND = "CURDQROOTCOND";
    public static final String DATAQUERY_CURLOGICDQ = "CURLOGICDQ";
    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_VIEW = "VIEW";
    public static final String DATASET_CURDQROOTCOND = "CURDQROOTCOND";
    public static final String DATASET_CURLOGICDQ = "CURLOGICDQ";
    public static final String DATASET_DEFAULT = "DEFAULT";

    public void ajaxFillCondValue(PSDEDQCondDTO dto) throws Throwable;

    public Page<PSDEDQCondDTO> fetchCurDQRootCond(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDQCondDTO> fetchCurLogicDQ(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDQCondDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
