...
@Qualifier(value="PSDEACMODEITEM")
public interface IPSDEACModeItemService
extends IPSModelDEService<PSDEACModeItemDTO, ISearchContextDTO> {
    ...
    public Page<PSDEACModeItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
