...
@Qualifier(value="PSDETREENODECOL")
public interface IPSDETreeNodeColService
extends IPSModelDEService<PSDETreeNodeColDTO, ISearchContextDTO> {
    ...
    public Page<PSDETreeNodeColDTO> fetchCurTreeNode(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDETreeNodeColDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
