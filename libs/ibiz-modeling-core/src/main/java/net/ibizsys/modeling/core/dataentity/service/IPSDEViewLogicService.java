...
@Qualifier(value="PSDEVIEWLOGIC")
public interface IPSDEViewLogicService
extends IPSModelDEService<PSDEViewLogicDTO, ISearchContextDTO> {
    ...
    public Page<PSDEViewLogicDTO> fetchCurView(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEViewLogicDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
