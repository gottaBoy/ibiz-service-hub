...
@Qualifier(value="PSDEVIEWENGINE")
public interface IPSDEViewEngineService
extends IPSModelDEService<PSDEViewEngineDTO, ISearchContextDTO> {
    ...
    public Page<PSDEViewEngineDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
