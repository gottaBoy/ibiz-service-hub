...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_SBTAG = "sbtag";
    public static final String FIELD_SBTAG2 = "SBTAG2";
    protected static final String DTOFIELD_SBTAG2 = "sbtag2";
    ...
    public static final String DTOFIELD_PSAPPSBITEMS = "psappsbitems";
    public static final String DTOFIELD_PSAPPSBITEMRSS = "psappsbitemrs";
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO codename(String codeName) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO defaultflag(Integer defaultFlag) {
        this.setDefaultFlag(defaultFlag);
        return this;
    }

    @JsonIgnore
    public PSAppStoryBoardDTO defaultflag(Boolean defaultFlag) {
        if (defaultFlag == null) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO psappstoryboardid(String pSAppStoryBoardId) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO psappstoryboardname(String pSAppStoryBoardName) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO name(String strName) {
        this.setPSAppStoryBoardName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO psdynainstid(String pSDynaInstId) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO pssysappid(String pSSysAppId) {
        this.setPSSysAppId(pSSysAppId);
        return this;
    }

    @JsonIgnore
    public PSAppStoryBoardDTO pssysappid(PSSysAppDTO pSSysApp) {
        if (pSSysApp == null) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO pssysappname(String pSSysAppName) {
    ...
    public void setSBTag(String sBTag) {
        this._set(DTOFIELD_SBTAG, sBTag);
    }

    @JsonIgnore
    public String getSBTag() {
        Object objValue = this._get(DTOFIELD_SBTAG);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isSBTagDirty() {
        return this._contains(DTOFIELD_SBTAG);
    }

    @JsonIgnore
    public void resetSBTag() {
        this._reset(DTOFIELD_SBTAG);
    }

    @JsonIgnore
    public PSAppStoryBoardDTO sbtag(String sBTag) {
        this.setSBTag(sBTag);
        return this;
    }
    ...
    public void setSBTag2(String sBTag2) {
        this._set(DTOFIELD_SBTAG2, sBTag2);
    }

    @JsonIgnore
    public String getSBTag2() {
        Object objValue = this._get(DTOFIELD_SBTAG2);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isSBTag2Dirty() {
        return this._contains(DTOFIELD_SBTAG2);
    }

    @JsonIgnore
    public void resetSBTag2() {
        this._reset(DTOFIELD_SBTAG2);
    }

    @JsonIgnore
    public PSAppStoryBoardDTO sbtag2(String sBTag2) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSAppStoryBoardDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO validflag(Integer validFlag) {
        this.setValidFlag(validFlag);
        return this;
    }

    @JsonIgnore
    public PSAppStoryBoardDTO validflag(Boolean validFlag) {
        if (validFlag == null) {
    ...
    @JsonIgnore
    public PSAppStoryBoardDTO id(String strValue) {
        this.setPSAppStoryBoardId(strValue);
        return this;
    }
    ...
    public List<PSAppSBItemDTO> getPSAppSBItems() {
        Object list = this._get(DTOFIELD_PSAPPSBITEMS);
    ...
    public void setPSAppSBItems(List<PSAppSBItemDTO> psappsbitems) {
        this._set(DTOFIELD_PSAPPSBITEMS, psappsbitems);
    }

    @JsonIgnore
    public List<PSAppSBItemDTO> getPSAppSBItemsIf() {
        Object list = this._get(DTOFIELD_PSAPPSBITEMS);
        if (!(list instanceof List)) {
            list = new ArrayList();
            this._set(DTOFIELD_PSAPPSBITEMS, list);
        }
        return (List) list;
    }

    @JsonIgnore
    public List<PSAppSBItemRSDTO> getPSAppSBItemRSs() {
        Object list = this._get(DTOFIELD_PSAPPSBITEMRSS);
        if (list instanceof List) {
            return (List)list;
        }
        return null;
    ...
    public void setPSAppSBItemRSs(List<PSAppSBItemRSDTO> psappsbitemrs) {
        this._set(DTOFIELD_PSAPPSBITEMRSS, psappsbitemrs);
    }

    @JsonIgnore
    public List<PSAppSBItemRSDTO> getPSAppSBItemRSsIf() {
        Object list = this._get(DTOFIELD_PSAPPSBITEMRSS);
        if (!(list instanceof List)) {
            list = new ArrayList();
            this._set(DTOFIELD_PSAPPSBITEMRSS, list);
        }
        return (List) list;
    }
}
