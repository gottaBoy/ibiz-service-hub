...
@Qualifier(value="PSSYSTESTCASE")
public interface IPSSysTestCaseService
extends IPSModelDEService<PSSysTestCaseDTO, ISearchContextDTO> {
    ...
    public Page<PSSysTestCaseDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysTestCaseDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysTestCaseDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysTestCaseDTO> fetchFormType(ISearchContextDTO searchContext) throws Throwable;
}
