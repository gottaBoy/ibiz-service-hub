...
@Qualifier(value="PSSYSVIEWPANEL")
public interface IPSSysViewPanelService
extends IPSModelDEService<PSSysViewPanelDTO, ISearchContextDTO> {
    ...
    public static final String ACTION_GETBYVIEWEMBED = "GETBYVIEWEMBED";
    ...
    public static final String ACTION_UPDATETOVIEWEMBED = "UPDATETOVIEWEMBED";
    ...
    public Page<PSSysViewPanelDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewPanelDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewPanelDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewPanelDTO> fetchCurSysCtrl(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewPanelDTO> fetchCurSysView(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewPanelDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewPanelDTO> fetchViewLayout(ISearchContextDTO searchContext) throws Throwable;
}
