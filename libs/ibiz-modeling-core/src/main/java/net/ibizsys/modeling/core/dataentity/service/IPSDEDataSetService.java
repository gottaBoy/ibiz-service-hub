...
@Qualifier(value="PSDEDATASET")
public interface IPSDEDataSetService
extends IPSModelDEService<PSDEDataSetDTO, ISearchContextDTO> {
    ...
    public Page<PSDEDataSetDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDataSetDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDataSetDTO> fetchCurSysNotSub(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDataSetDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
