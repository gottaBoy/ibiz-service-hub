...
@Qualifier(value="PSDEWIZARDSTEP")
public interface IPSDEWizardStepService
extends IPSModelDEService<PSDEWizardStepDTO, ISearchContextDTO> {
    ...
    public Page<PSDEWizardStepDTO> fetchCurDEWizard(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEWizardStepDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
