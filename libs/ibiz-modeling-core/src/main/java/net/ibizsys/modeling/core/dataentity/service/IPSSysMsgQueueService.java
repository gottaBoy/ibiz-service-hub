...
@Qualifier(value="PSSYSMSGQUEUE")
public interface IPSSysMsgQueueService
extends IPSModelDEService<PSSysMsgQueueDTO, ISearchContextDTO> {
    ...
    public Page<PSSysMsgQueueDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysMsgQueueDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
