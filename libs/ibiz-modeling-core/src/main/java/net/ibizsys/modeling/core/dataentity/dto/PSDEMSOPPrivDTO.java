...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSDEMSOPPRIVID = "psdemsopprivid";
    public static final String FIELD_PSDEMSOPPRIVNAME = "PSDEMSOPPRIVNAME";
    protected static final String DTOFIELD_PSDEMSOPPRIVNAME = "psdemsopprivname";
    ...
    public void setPSDEMSOPPrivId(String pSDEMSOPPrivId) {
        this._set(DTOFIELD_PSDEMSOPPRIVID, pSDEMSOPPrivId);
    }

    @JsonIgnore
    public String getPSDEMSOPPrivId() {
        Object objValue = this._get(DTOFIELD_PSDEMSOPPRIVID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEMSOPPrivIdDirty() {
        return this._contains(DTOFIELD_PSDEMSOPPRIVID);
    }

    @JsonIgnore
    public void resetPSDEMSOPPrivId() {
        this._reset(DTOFIELD_PSDEMSOPPRIVID);
    }
    ...
    public void setPSDEMSOPPrivName(String pSDEMSOPPrivName) {
        this._set(DTOFIELD_PSDEMSOPPRIVNAME, pSDEMSOPPrivName);
    }

    @JsonIgnore
    public String getPSDEMSOPPrivName() {
        Object objValue = this._get(DTOFIELD_PSDEMSOPPRIVNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEMSOPPrivNameDirty() {
        return this._contains(DTOFIELD_PSDEMSOPPRIVNAME);
    }

    @JsonIgnore
    public void resetPSDEMSOPPrivName() {
        this._reset(DTOFIELD_PSDEMSOPPRIVNAME);
    }
    ...
    @JsonIgnore
    public PSDEMSOPPrivDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
