...
@Qualifier(value="PSDENOTIFY")
public interface IPSDENotifyService
extends IPSModelDEService<PSDENotifyDTO, ISearchContextDTO> {
    ...
    public Page<PSDENotifyDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDENotifyDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
