...
@Qualifier(value="PSAPPMENU")
public interface IPSAppMenuService
extends IPSModelDEService<PSAppMenuDTO, ISearchContextDTO> {
    ...
    public Page<PSAppMenuDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppMenuDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
