...
@Qualifier(value="PSDEMAINSTATE")
public interface IPSDEMainStateService
extends IPSModelDEService<PSDEMainStateDTO, ISearchContextDTO> {
    ...
    public void initDEMSViews(PSDEMainStateDTO dto) throws Throwable;

    public Page<PSDEMainStateDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEMainStateDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
