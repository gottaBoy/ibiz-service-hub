...
@Qualifier(value="PSWFPROCSUBWF")
public interface IPSWFProcSubWFService
extends IPSModelDEService<PSWFProcSubWFDTO, ISearchContextDTO> {
    ...
    public void calcEmbedDEIdByEmbedWFDE(PSWFProcSubWFDTO dto) throws Throwable;

    public Page<PSWFProcSubWFDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
