...
@Qualifier(value="PSDERGROUP")
public interface IPSDERGroupService
extends IPSModelDEService<PSDERGroupDTO, ISearchContextDTO> {
    ...
    public Page<PSDERGroupDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDERGroupDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDERGroupDTO> fetchCurSys2(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDERGroupDTO> fetchCurSysAll(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDERGroupDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
