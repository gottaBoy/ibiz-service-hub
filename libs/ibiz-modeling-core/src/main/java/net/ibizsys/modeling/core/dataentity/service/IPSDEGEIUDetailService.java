...
@Qualifier(value="PSDEGEIUDETAIL")
public interface IPSDEGEIUDetailService
extends IPSModelDEService<PSDEGEIUDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSDEGEIUDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
