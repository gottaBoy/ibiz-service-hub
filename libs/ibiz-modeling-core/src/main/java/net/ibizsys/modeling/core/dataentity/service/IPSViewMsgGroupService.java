...
@Qualifier(value="PSVIEWMSGGROUP")
public interface IPSViewMsgGroupService
extends IPSModelDEService<PSViewMsgGroupDTO, ISearchContextDTO> {
    ...
    public Page<PSViewMsgGroupDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSViewMsgGroupDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
