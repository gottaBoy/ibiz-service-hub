...
@Qualifier(value="PSCTRLLOGICGRPDETAIL")
public interface IPSCtrlLogicGrpDetailService
extends IPSModelDEService<PSCtrlLogicGrpDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSCtrlLogicGrpDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
