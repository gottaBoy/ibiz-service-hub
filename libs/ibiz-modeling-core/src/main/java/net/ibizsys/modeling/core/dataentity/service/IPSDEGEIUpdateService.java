...
@Qualifier(value="PSDEGEIUPDATE")
public interface IPSDEGEIUpdateService
extends IPSModelDEService<PSDEGEIUpdateDTO, ISearchContextDTO> {
    ...
    public Page<PSDEGEIUpdateDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
