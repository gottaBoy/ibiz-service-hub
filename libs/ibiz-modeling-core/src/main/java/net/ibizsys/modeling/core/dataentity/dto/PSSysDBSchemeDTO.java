...
extends PSModelDTOBase {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO authclientid(String authClientId) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO authclientsecret(String authClientSecret) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO authmode(String authMode) {
        this.setAuthMode(authMode);
        return this;
    }

    @JsonIgnore
    public PSSysDBSchemeDTO authmode(PSModelEnums.APIAuthMode authMode) {
        if (authMode == null) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO authparam(String authParam) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO authparam2(String authParam2) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO dslink(PSModelEnums.DataSourceLink dSLink) {
        if (dSLink == null) {
            this.setDSLink(null);
        } else {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO objnamecase(String objNameCase) {
        this.setObjNameCase(objNameCase);
        return this;
    }

    @JsonIgnore
    public PSSysDBSchemeDTO objnamecase(PSModelEnums.StringCaseMode objNameCase) {
        if (objNameCase == null) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO serviceparam(String serviceParam) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO serviceparam2(String serviceParam2) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO servicepath(String servicePath) {
    ...
    @JsonIgnore
    public PSSysDBSchemeDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
