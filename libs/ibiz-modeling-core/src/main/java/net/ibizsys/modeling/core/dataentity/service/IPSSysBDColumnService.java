...
@Qualifier(value="PSSYSBDCOLUMN")
public interface IPSSysBDColumnService
extends IPSModelDEService<PSSysBDColumnDTO, ISearchContextDTO> {
    ...
    public void calcPSDE_FI(PSSysBDColumnDTO dto) throws Throwable;

    public Page<PSSysBDColumnDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
