...
@Qualifier(value="PSSYSBIREPORT")
public interface IPSSysBIReportService
extends IPSModelDEService<PSSysBIReportDTO, ISearchContextDTO> {
    ...
    public Page<PSSysBIReportDTO> fetchCurScheme(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysBIReportDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
