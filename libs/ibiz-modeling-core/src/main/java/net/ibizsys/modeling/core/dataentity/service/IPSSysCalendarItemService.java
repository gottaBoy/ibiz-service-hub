...
@Qualifier(value="PSSYSCALENDARITEM")
public interface IPSSysCalendarItemService
extends IPSModelDEService<PSSysCalendarItemDTO, ISearchContextDTO> {
    ...
    public Page<PSSysCalendarItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
