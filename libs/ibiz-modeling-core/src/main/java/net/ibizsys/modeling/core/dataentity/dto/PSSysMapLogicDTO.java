...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSSYSMAPLOGICID = "pssysmaplogicid";
    public static final String FIELD_PSSYSMAPLOGICNAME = "PSSYSMAPLOGICNAME";
    protected static final String DTOFIELD_PSSYSMAPLOGICNAME = "pssysmaplogicname";
    ...
    @JsonIgnore
    public PSSysMapLogicDTO dstlogictype(PSModelEnums.TargetUILogic dstLogicType) {
    ...
    @JsonProperty(value="pssysmaplogicid")
    public void setPSSysMapLogicId(String pSSysMapLogicId) {
        this._set(DTOFIELD_PSSYSMAPLOGICID, pSSysMapLogicId);
    }

    @JsonIgnore
    public String getPSSysMapLogicId() {
        Object objValue = this._get(DTOFIELD_PSSYSMAPLOGICID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSysMapLogicIdDirty() {
        return this._contains(DTOFIELD_PSSYSMAPLOGICID);
    }

    @JsonIgnore
    public void resetPSSysMapLogicId() {
        this._reset(DTOFIELD_PSSYSMAPLOGICID);
    }
    ...
    @JsonProperty(value="pssysmaplogicname")
    public void setPSSysMapLogicName(String pSSysMapLogicName) {
        this._set(DTOFIELD_PSSYSMAPLOGICNAME, pSSysMapLogicName);
    }

    @JsonIgnore
    public String getPSSysMapLogicName() {
        Object objValue = this._get(DTOFIELD_PSSYSMAPLOGICNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSysMapLogicNameDirty() {
        return this._contains(DTOFIELD_PSSYSMAPLOGICNAME);
    }

    @JsonIgnore
    public void resetPSSysMapLogicName() {
        this._reset(DTOFIELD_PSSYSMAPLOGICNAME);
    }
    ...
    @JsonIgnore
    public PSSysMapLogicDTO triggertype(PSModelEnums.ViewLogicTrigger triggerType) {
        if (triggerType == null) {
    ...
    @JsonIgnore
    public PSSysMapLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
