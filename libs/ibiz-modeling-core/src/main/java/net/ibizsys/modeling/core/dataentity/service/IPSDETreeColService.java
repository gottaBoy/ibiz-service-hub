...
@Qualifier(value="PSDETREECOL")
public interface IPSDETreeColService
extends IPSModelDEService<PSDETreeColDTO, ISearchContextDTO> {
    ...
    public Page<PSDETreeColDTO> fetchCurTree(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDETreeColDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDETreeColDTO> fetchFormType(ISearchContextDTO searchContext) throws Throwable;
}
