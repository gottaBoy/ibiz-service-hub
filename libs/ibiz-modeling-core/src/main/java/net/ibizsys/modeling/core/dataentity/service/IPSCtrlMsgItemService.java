...
@Qualifier(value="PSCTRLMSGITEM")
public interface IPSCtrlMsgItemService
extends IPSModelDEService<PSCtrlMsgItemDTO, ISearchContextDTO> {
    ...
    public Page<PSCtrlMsgItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
