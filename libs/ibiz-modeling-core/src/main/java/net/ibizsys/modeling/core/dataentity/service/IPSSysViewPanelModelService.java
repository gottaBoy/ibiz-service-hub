...
@Qualifier(value="PSSYSVIEWPANELMODEL")
public interface IPSSysViewPanelModelService
extends IPSModelDEService<PSSysViewPanelModelDTO, ISearchContextDTO> {
    ...
    public Page<PSSysViewPanelModelDTO> fetchCurPanel(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewPanelModelDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
