...
@Qualifier(value="PSDEUAGRPDETAIL")
public interface IPSDEUAGroupDetailService
extends IPSModelDEService<PSDEUAGroupDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSDEUAGroupDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
