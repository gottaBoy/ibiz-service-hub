...
@Qualifier(value="PSDELISTITEM")
public interface IPSDEListItemService
extends IPSModelDEService<PSDEListItemDTO, ISearchContextDTO> {
    ...
    public Page<PSDEListItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
