...
@Qualifier(value="PSDEACMODE")
public interface IPSDEACModeService
extends IPSModelDEService<PSDEACModeDTO, ISearchContextDTO> {
    ...
    public Page<PSDEACModeDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEACModeDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
