...
public class PSSysSampleValueDTO
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_NULLVALUE = "nullvalue";
    public static final String FIELD_PSMODULEID = "PSMODULEID";
    protected static final String DTOFIELD_PSMODULEID = "psmoduleid";
    public static final String FIELD_PSMODULENAME = "PSMODULENAME";
    protected static final String DTOFIELD_PSMODULENAME = "psmodulename";
    public static final String FIELD_PSSAMPLEVALUEID = "PSSAMPLEVALUEID";
    protected static final String DTOFIELD_PSSAMPLEVALUEID = "pssamplevalueid";
    public static final String FIELD_PSSAMPLEVALUENAME = "PSSAMPLEVALUENAME";
    protected static final String DTOFIELD_PSSAMPLEVALUENAME = "pssamplevaluename";
    ...
    protected static final String DTOFIELD_VALUELIST = "valuelist";
    ...
    @JsonIgnore
    public PSSysSampleValueDTO codename(String codeName) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO customcode(String customCode) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO custommode(Integer customMode) {
        this.setCustomMode(customMode);
        return this;
    }

    @JsonIgnore
    public PSSysSampleValueDTO custommode(PSModelEnums.ScriptMode2 customMode) {
        if (customMode == null) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }
    ...
    public void setNullValue(Integer nullValue) {
        this._set(DTOFIELD_NULLVALUE, nullValue);
    }

    @JsonIgnore
    public Integer getNullValue() {
        Object objValue = this._get(DTOFIELD_NULLVALUE);
        if (objValue == null) {
            return null;
        }
        return (Integer)objValue;
    ...
    public boolean isNullValueDirty() {
        return this._contains(DTOFIELD_NULLVALUE);
    }

    @JsonIgnore
    public void resetNullValue() {
        this._reset(DTOFIELD_NULLVALUE);
    }

    @JsonIgnore
    public PSSysSampleValueDTO nullvalue(Integer nullValue) {
        this.setNullValue(nullValue);
        return this;
    }

    @JsonIgnore
    public PSSysSampleValueDTO nullvalue(Boolean nullValue) {
        if (nullValue == null) {
            this.setNullValue(null);
        } else {
            this.setNullValue(nullValue != false ? 1 : 0);
        }
        return this;
    }
    ...
    @JsonIgnore
    public PSSysSampleValueDTO psmoduleid(String pSModuleId) {
        this.setPSModuleId(pSModuleId);
        return this;
    }

    @JsonIgnore
    public PSSysSampleValueDTO psmoduleid(PSModuleDTO pSModule) {
        if (pSModule == null) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO psmodulename(String pSModuleName) {
        this.setPSModuleName(pSModuleName);
        return this;
    }

    @JsonProperty(value="pssamplevalueid")
    public void setPSSampleValueId(String pSSampleValueId) {
        this._set(DTOFIELD_PSSAMPLEVALUEID, pSSampleValueId);
    }

    @JsonIgnore
    public String getPSSampleValueId() {
        Object objValue = this._get(DTOFIELD_PSSAMPLEVALUEID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSampleValueIdDirty() {
        return this._contains(DTOFIELD_PSSAMPLEVALUEID);
    }

    @JsonIgnore
    public void resetPSSampleValueId() {
        this._reset(DTOFIELD_PSSAMPLEVALUEID);
    }

    @JsonIgnore
    public PSSysSampleValueDTO pssamplevalueid(String pSSampleValueId) {
        this.setPSSampleValueId(pSSampleValueId);
        return this;
    }

    @JsonProperty(value="pssamplevaluename")
    public void setPSSampleValueName(String pSSampleValueName) {
        this._set(DTOFIELD_PSSAMPLEVALUENAME, pSSampleValueName);
    }

    @JsonIgnore
    public String getPSSampleValueName() {
        Object objValue = this._get(DTOFIELD_PSSAMPLEVALUENAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSampleValueNameDirty() {
        return this._contains(DTOFIELD_PSSAMPLEVALUENAME);
    }

    @JsonIgnore
    public void resetPSSampleValueName() {
        this._reset(DTOFIELD_PSSAMPLEVALUENAME);
    }

    @JsonIgnore
    public PSSysSampleValueDTO pssamplevaluename(String pSSampleValueName) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO pssyssamplevalueid(String pSSysSampleValueId) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO pssyssamplevaluename(String pSSysSampleValueName) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO name(String strName) {
        this.setPSSysSampleValueName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysSampleValueDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSSysSampleValueDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO validflag(Integer validFlag) {
        this.setValidFlag(validFlag);
        return this;
    }

    @JsonIgnore
    public PSSysSampleValueDTO validflag(Boolean validFlag) {
        if (validFlag == null) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO value(String value) {
        this.setValue(value);
        return this;
    }
    ...
    public void setValueList(String valueList) {
        this._set(DTOFIELD_VALUELIST, valueList);
    }

    @JsonIgnore
    public String getValueList() {
        Object objValue = this._get(DTOFIELD_VALUELIST);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isValueListDirty() {
        return this._contains(DTOFIELD_VALUELIST);
    }

    @JsonIgnore
    public void resetValueList() {
        this._reset(DTOFIELD_VALUELIST);
    }

    @JsonIgnore
    public PSSysSampleValueDTO valuelist(String valueList) {
    ...
    @JsonIgnore
    public PSSysSampleValueDTO id(String strValue) {
        this.setPSSysSampleValueId(strValue);
        return this;
    }
}
