...
@Qualifier(value="PSDEACTIONGROUP")
public interface IPSDEActionGroupService
extends IPSModelDEService<PSDEActionGroupDTO, ISearchContextDTO> {
    ...
    public Page<PSDEActionGroupDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEActionGroupDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
