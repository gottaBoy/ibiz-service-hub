...
@Qualifier(value="PSDETEIUPDATE")
public interface IPSDETEIUpdateService
extends IPSModelDEService<PSDETEIUpdateDTO, ISearchContextDTO> {
    ...
    public Page<PSDETEIUpdateDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
