...
@Qualifier(value="PSSYSBICUBEDIMENSION")
public interface IPSSysBICubeDimensionService
extends IPSModelDEService<PSSysBICubeDimensionDTO, ISearchContextDTO> {
    ...
    public Page<PSSysBICubeDimensionDTO> fetchCurCube(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysBICubeDimensionDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
