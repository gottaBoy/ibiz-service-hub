...
@Qualifier(value="PSDEFIVR")
public interface IPSDEFIVRService
extends IPSModelDEService<PSDEFIVRDTO, ISearchContextDTO> {
    ...
    public Page<PSDEFIVRDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
