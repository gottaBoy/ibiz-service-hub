...
@Qualifier(value="PSSYSBDMODULE")
public interface IPSSysBDModuleService
extends IPSModelDEService<PSSysBDModuleDTO, ISearchContextDTO> {
    ...
    public void initBDTables(PSSysBDModuleDTO dto) throws Throwable;

    public Page<PSSysBDModuleDTO> fetchCurScheme(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysBDModuleDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
