...
@Qualifier(value="PSSUBSYSSADEFIELD")
public interface IPSSubSysSADEFieldService
extends IPSModelDEService<PSSubSysSADEFieldDTO, ISearchContextDTO> {
    ...
    public Page<PSSubSysSADEFieldDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
