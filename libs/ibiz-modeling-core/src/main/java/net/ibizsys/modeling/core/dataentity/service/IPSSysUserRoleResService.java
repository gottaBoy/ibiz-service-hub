...
@Qualifier(value="PSSYSUSERROLERES")
public interface IPSSysUserRoleResService
extends IPSModelDEService<PSSysUserRoleResDTO, ISearchContextDTO> {
    ...
    public Page<PSSysUserRoleResDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
