...
@Qualifier(value="PSDEACTIONVR")
public interface IPSDEActionVRService
extends IPSModelDEService<PSDEActionVRDTO, ISearchContextDTO> {
    ...
    public Page<PSDEActionVRDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
