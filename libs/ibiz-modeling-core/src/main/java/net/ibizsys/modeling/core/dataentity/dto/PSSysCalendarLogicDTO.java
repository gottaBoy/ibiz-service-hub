...
public class PSSysCalendarLogicDTO
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSSYSCALENDARLOGICID = "pssyscalendarlogicid";
    public static final String FIELD_PSSYSCALENDARLOGICNAME = "PSSYSCALENDARLOGICNAME";
    protected static final String DTOFIELD_PSSYSCALENDARLOGICNAME = "pssyscalendarlogicname";
    ...
    @JsonIgnore
    public PSSysCalendarLogicDTO dstlogictype(PSModelEnums.TargetUILogic dstLogicType) {
    ...
    @JsonProperty(value="pssyscalendarlogicid")
    public void setPSSysCalendarLogicId(String pSSysCalendarLogicId) {
        this._set(DTOFIELD_PSSYSCALENDARLOGICID, pSSysCalendarLogicId);
    }

    @JsonIgnore
    public String getPSSysCalendarLogicId() {
        Object objValue = this._get(DTOFIELD_PSSYSCALENDARLOGICID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSysCalendarLogicIdDirty() {
        return this._contains(DTOFIELD_PSSYSCALENDARLOGICID);
    }

    @JsonIgnore
    public void resetPSSysCalendarLogicId() {
        this._reset(DTOFIELD_PSSYSCALENDARLOGICID);
    }
    ...
    @JsonProperty(value="pssyscalendarlogicname")
    public void setPSSysCalendarLogicName(String pSSysCalendarLogicName) {
        this._set(DTOFIELD_PSSYSCALENDARLOGICNAME, pSSysCalendarLogicName);
    }

    @JsonIgnore
    public String getPSSysCalendarLogicName() {
        Object objValue = this._get(DTOFIELD_PSSYSCALENDARLOGICNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSysCalendarLogicNameDirty() {
        return this._contains(DTOFIELD_PSSYSCALENDARLOGICNAME);
    }

    @JsonIgnore
    public void resetPSSysCalendarLogicName() {
        this._reset(DTOFIELD_PSSYSCALENDARLOGICNAME);
    }
    ...
    @JsonIgnore
    public PSSysCalendarLogicDTO triggertype(PSModelEnums.ViewLogicTrigger triggerType) {
        if (triggerType == null) {
    ...
    @JsonIgnore
    public PSSysCalendarLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
