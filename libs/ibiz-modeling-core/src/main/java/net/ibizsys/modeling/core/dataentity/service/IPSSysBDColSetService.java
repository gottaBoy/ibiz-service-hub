...
@Qualifier(value="PSSYSBDCOLSET")
public interface IPSSysBDColSetService
extends IPSModelDEService<PSSysBDColSetDTO, ISearchContextDTO> {
    ...
    public Page<PSSysBDColSetDTO> fetchCurBDT(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysBDColSetDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
