...
@Qualifier(value="PSDETREENODE")
public interface IPSDETreeNodeService
extends IPSModelDEService<PSDETreeNodeDTO, ISearchContextDTO> {
    ...
    public Page<PSDETreeNodeDTO> fetchCurTree(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDETreeNodeDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
