...
@Qualifier(value="PSSYSMAPVIEW")
public interface IPSSysMapViewService
extends IPSModelDEService<PSSysMapViewDTO, ISearchContextDTO> {
    ...
    public Page<PSSysMapViewDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysMapViewDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysMapViewDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
