...
@Qualifier(value="PSDEACTIONPARAM")
public interface IPSDEActionParamService
extends IPSModelDEService<PSDEActionParamDTO, ISearchContextDTO> {
    ...
    public Page<PSDEActionParamDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
