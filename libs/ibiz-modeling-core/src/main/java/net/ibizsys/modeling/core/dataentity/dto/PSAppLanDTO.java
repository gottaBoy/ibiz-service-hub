...
public class PSAppLanDTO
extends PSNamedModelDTOBase {
    private static final long serialVersionUID = 1L;

    public PSAppLanDTO() {
        super("psapplanid", "psapplanname");
    }
    ...
    public static final String FIELD_PSAPPLANID = "PSAPPLANID";
    protected static final String DTOFIELD_PSAPPLANID = "psapplanid";
    public static final String FIELD_PSAPPLANNAME = "PSAPPLANNAME";
    protected static final String DTOFIELD_PSAPPLANNAME = "psapplanname";
    ...
    @JsonIgnore
    public PSAppLanDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSAppLanDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSAppLanDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }
    ...
    @JsonIgnore
    public PSAppLanDTO ordervalue(Integer orderValue) {
        this.setOrderValue(orderValue);
        return this;
    }

    @JsonProperty(value="psapplanid")
    public void setPSAppLanId(String pSAppLanId) {
        this._set(DTOFIELD_PSAPPLANID, pSAppLanId);
    }

    @JsonIgnore
    public String getPSAppLanId() {
        Object objValue = this._get(DTOFIELD_PSAPPLANID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSAppLanIdDirty() {
        return this._contains(DTOFIELD_PSAPPLANID);
    }

    @JsonIgnore
    public void resetPSAppLanId() {
        this._reset(DTOFIELD_PSAPPLANID);
    }

    @JsonIgnore
    public PSAppLanDTO psapplanid(String pSAppLanId) {
        this.setPSAppLanId(pSAppLanId);
        return this;
    }

    @JsonProperty(value="psapplanname")
    public void setPSAppLanName(String pSAppLanName) {
        this._set(DTOFIELD_PSAPPLANNAME, pSAppLanName);
    }

    @JsonIgnore
    public String getPSAppLanName() {
        Object objValue = this._get(DTOFIELD_PSAPPLANNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSAppLanNameDirty() {
        return this._contains(DTOFIELD_PSAPPLANNAME);
    }

    @JsonIgnore
    public void resetPSAppLanName() {
        this._reset(DTOFIELD_PSAPPLANNAME);
    }

    @JsonIgnore
    public PSAppLanDTO psapplanname(String pSAppLanName) {
    ...
    @JsonIgnore
    public PSAppLanDTO name(String strName) {
        this.setPSAppLanName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSAppLanDTO pslanguageid(String pSLanguageId) {
        this.setPSLanguageId(pSLanguageId);
        return this;
    }

    @JsonIgnore
    public PSAppLanDTO pslanguageid(PSLanguageDTO pSLanguage) {
        if (pSLanguage == null) {
    ...
    @JsonIgnore
    public PSAppLanDTO pslanguagename(String pSLanguageName) {
    ...
    @JsonIgnore
    public PSAppLanDTO pssysappid(String pSSysAppId) {
        this.setPSSysAppId(pSSysAppId);
        return this;
    }

    @JsonIgnore
    public PSAppLanDTO pssysappid(PSSysAppDTO pSSysApp) {
        if (pSSysApp == null) {
    ...
    @JsonIgnore
    public PSAppLanDTO pssysappname(String pSSysAppName) {
    ...
    @JsonIgnore
    public PSAppLanDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSAppLanDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSAppLanDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSAppLanDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSAppLanDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSAppLanDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSAppLanDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSAppLanDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSAppLanDTO validflag(Integer validFlag) {
        this.setValidFlag(validFlag);
        return this;
    }

    @JsonIgnore
    public PSAppLanDTO validflag(Boolean validFlag) {
        if (validFlag == null) {
    ...
    @JsonIgnore
    public PSAppLanDTO id(String strValue) {
        this.setPSAppLanId(strValue);
        return this;
    }
}
