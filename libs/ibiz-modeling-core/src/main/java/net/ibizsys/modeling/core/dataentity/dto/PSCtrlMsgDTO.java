...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_MSGMODEL = "msgmodel";
    ...
    public static final String DTOFIELD_PSCTRLMSGITEMS = "psctrlmsgitems";
    ...
    @JsonIgnore
    public PSCtrlMsgDTO codename(String codeName) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }

    @JsonProperty(value="msgmodel")
    public void setMsgModel(String msgModel) {
        this._set(DTOFIELD_MSGMODEL, msgModel);
    }

    @JsonIgnore
    public String getMsgModel() {
        Object objValue = this._get(DTOFIELD_MSGMODEL);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isMsgModelDirty() {
        return this._contains(DTOFIELD_MSGMODEL);
    }

    @JsonIgnore
    public void resetMsgModel() {
        this._reset(DTOFIELD_MSGMODEL);
    }

    @JsonIgnore
    public PSCtrlMsgDTO msgmodel(String msgModel) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO psctrlmsgid(String pSCtrlMsgId) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO psctrlmsgname(String pSCtrlMsgName) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO name(String strName) {
        this.setPSCtrlMsgName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSCtrlMsgDTO psdeid(String pSDEId) {
        this.setPSDEId(pSDEId);
        return this;
    }

    @JsonIgnore
    public PSCtrlMsgDTO psdeid(PSDataEntityDTO pSDataEntity) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO psdename(String pSDEName) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO psdeviewctrltype(String pSDEViewCtrlType) {
        this.setPSDEViewCtrlType(pSDEViewCtrlType);
        return this;
    }

    @JsonIgnore
    public PSCtrlMsgDTO psdeviewctrltype(PSModelEnums.CtrlType pSDEViewCtrlType) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO psmoduleid(String pSModuleId) {
        this.setPSModuleId(pSModuleId);
        return this;
    }

    @JsonIgnore
    public PSCtrlMsgDTO psmoduleid(PSModuleDTO pSModule) {
        if (pSModule == null) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO psmodulename(String pSModuleName) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO pssysdynamodelid(String pSSysDynaModelId) {
        this.setPSSysDynaModelId(pSSysDynaModelId);
        return this;
    }

    @JsonIgnore
    public PSCtrlMsgDTO pssysdynamodelid(PSSysDynaModelDTO pSSysDynaModel) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO pssysdynamodelname(String pSSysDynaModelName) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSCtrlMsgDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSCtrlMsgDTO id(String strValue) {
        this.setPSCtrlMsgId(strValue);
        return this;
    }

    @JsonIgnore
    public List<PSCtrlMsgItemDTO> getPSCtrlMsgItems() {
        Object list = this._get(DTOFIELD_PSCTRLMSGITEMS);
    ...
    @JsonProperty(value="psctrlmsgitems")
    public void setPSCtrlMsgItems(List<PSCtrlMsgItemDTO> psctrlmsgitems) {
        this._set(DTOFIELD_PSCTRLMSGITEMS, psctrlmsgitems);
    }

    @JsonIgnore
    public List<PSCtrlMsgItemDTO> getPSCtrlMsgItemsIf() {
        Object list = this._get(DTOFIELD_PSCTRLMSGITEMS);
        if (!(list instanceof List)) {
            list = new ArrayList();
            this._set(DTOFIELD_PSCTRLMSGITEMS, list);
        }
        return (List) list;
    }
}
