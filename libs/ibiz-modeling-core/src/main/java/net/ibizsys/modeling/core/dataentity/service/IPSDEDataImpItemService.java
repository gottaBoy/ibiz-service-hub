...
@Qualifier(value="PSDEDATAIMPITEM")
public interface IPSDEDataImpItemService
extends IPSModelDEService<PSDEDataImpItemDTO, ISearchContextDTO> {
    ...
    public Page<PSDEDataImpItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
