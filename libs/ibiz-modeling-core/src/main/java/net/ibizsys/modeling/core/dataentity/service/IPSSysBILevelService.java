...
@Qualifier(value="PSSYSBILEVEL")
public interface IPSSysBILevelService
extends IPSModelDEService<PSSysBILevelDTO, ISearchContextDTO> {
    ...
    public Page<PSSysBILevelDTO> fetchCurHierarchy(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysBILevelDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
