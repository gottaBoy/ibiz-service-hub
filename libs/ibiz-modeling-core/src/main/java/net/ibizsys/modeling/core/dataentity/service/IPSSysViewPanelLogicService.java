...
@Qualifier(value="PSSYSVIEWPANELLOGIC")
public interface IPSSysViewPanelLogicService
extends IPSModelDEService<PSSysViewPanelLogicDTO, ISearchContextDTO> {
    ...
    public Page<PSSysViewPanelLogicDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
