...
@Qualifier(value="PSDEFIUPDATE")
public interface IPSDEFIUpdateService
extends IPSModelDEService<PSDEFIUpdateDTO, ISearchContextDTO> {
    ...
    public Page<PSDEFIUpdateDTO> fetchCurForm(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEFIUpdateDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
