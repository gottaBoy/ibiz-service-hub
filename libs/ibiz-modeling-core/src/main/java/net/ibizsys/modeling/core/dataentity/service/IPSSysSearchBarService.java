...
@Qualifier(value="PSSYSSEARCHBAR")
public interface IPSSysSearchBarService
extends IPSModelDEService<PSSysSearchBarDTO, ISearchContextDTO> {
    ...
    public Page<PSSysSearchBarDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSearchBarDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSearchBarDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSearchBarDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
