...
@Qualifier(value="PSSYSDASHBOARD")
public interface IPSSysDashboardService
extends IPSModelDEService<PSSysDashboardDTO, ISearchContextDTO> {
    ...
    public void createWithModel(PSSysDashboardDTO dto) throws Throwable;

    public PSSysDashboardDTO getDraftFromWithModel(PSSysDashboardDTO dto) throws Throwable;

    public PSSysDashboardDTO getDraftWithModel(PSSysDashboardDTO dto) throws Throwable;

    public PSSysDashboardDTO getWithModel(String value) throws Throwable;

    public void previewSave(PSSysDashboardDTO dto) throws Throwable;

    public void updateWithModel(PSSysDashboardDTO dto) throws Throwable;

    public Page<PSSysDashboardDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysDashboardDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysDashboardDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysDashboardDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
