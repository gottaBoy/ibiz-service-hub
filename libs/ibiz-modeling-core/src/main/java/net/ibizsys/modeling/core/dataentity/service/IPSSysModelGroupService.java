...
@Qualifier(value="PSSYSMODELGROUP")
public interface IPSSysModelGroupService
extends IPSModelDEService<PSSysModelGroupDTO, ISearchContextDTO> {
    ...
    public Page<PSSysModelGroupDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysModelGroupDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
