...
@Qualifier(value="PSDETBITEM")
public interface IPSDETBItemService
extends IPSModelDEService<PSDETBItemDTO, ISearchContextDTO> {
    ...
    public static final String DATAQUERY_CURTOOBARROOTITEM = "CURTOOBARROOTITEM";
    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_VIEW = "VIEW";
    public static final String DATASET_CURTOOBARROOTITEM = "CURTOOBARROOTITEM";
    public static final String DATASET_DEFAULT = "DEFAULT";

    public Page<PSDETBItemDTO> fetchCurToobarRootItem(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDETBItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
