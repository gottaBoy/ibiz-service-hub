...
@Qualifier(value="PSDEFINPUTTIPSET")
public interface IPSDEFInputTipSetService
extends IPSModelDEService<PSDEFInputTipSetDTO, ISearchContextDTO> {
    ...
    public Page<PSDEFInputTipSetDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEFInputTipSetDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
