...
@Qualifier(value="PSAPPPVPART")
public interface IPSAppPVPartService
extends IPSModelDEService<PSAppPVPartDTO, ISearchContextDTO> {
    ...
    public static final String DATAQUERY_CURROOT = "CURROOT";
    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_VIEW = "VIEW";
    public static final String DATASET_CURROOT = "CURROOT";
    public static final String DATASET_DEFAULT = "DEFAULT";

    public Page<PSAppPVPartDTO> fetchCurRoot(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppPVPartDTO> fetchDEFAULT(ISearchContextDTO searchContext) throws Throwable;
}
