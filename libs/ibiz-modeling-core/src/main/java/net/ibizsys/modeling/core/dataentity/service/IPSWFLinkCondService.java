...
@Qualifier(value="PSWFLINKCOND")
public interface IPSWFLinkCondService
extends IPSModelDEService<PSWFLinkCondDTO, ISearchContextDTO> {
    ...
    public static final String DATAQUERY_CURWFLINK = "CURWFLINK";
    public static final String DATAQUERY_CURWFLINKROOTLOGIC = "CURWFLINKROOTLOGIC";
    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_VIEW = "VIEW";
    public static final String DATASET_CURWFLINK = "CURWFLINK";
    public static final String DATASET_CURWFLINKROOTLOGIC = "CURWFLINKROOTLOGIC";
    public static final String DATASET_DEFAULT = "DEFAULT";

    public Page<PSWFLinkCondDTO> fetchCurWFLinkRootLogic(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSWFLinkCondDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
