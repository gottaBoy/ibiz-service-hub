...
@Qualifier(value="PSSYSDYNAMODELATTR")
public interface IPSSysDynaModelAttrService
extends IPSModelDEService<PSSysDynaModelAttrDTO, ISearchContextDTO> {
    ...
    public Page<PSSysDynaModelAttrDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
