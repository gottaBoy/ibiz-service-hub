...
@Qualifier(value="PSWFPROCROLE")
public interface IPSWFProcRoleService
extends IPSModelDEService<PSWFProcRoleDTO, ISearchContextDTO> {
    ...
    public static final String ACTION_PSWFROLENAMEFORMUPDATE = "PSWFROLENAMEFORMUPDATE";
    public static final String ACTION_SAVE = "SAVE";
    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_VIEW = "VIEW";
    public static final String DATASET_DEFAULT = "DEFAULT";

    public Page<PSWFProcRoleDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
