...
public class PSSysAIChatAgentDTO
extends PSModelDTOBase {
    public static final String FIELD_AICHATAGENTPARAMS = "AICHATAGENTPARAMS";
    protected static final String DTOFIELD_AICHATAGENTPARAMS = "aichatagentparams";
    public static final String FIELD_AICHATAGENTTAG = "AICHATAGENTTAG";
    protected static final String DTOFIELD_AICHATAGENTTAG = "aichatagenttag";
    public static final String FIELD_AICHATAGENTTAG2 = "AICHATAGENTTAG2";
    protected static final String DTOFIELD_AICHATAGENTTAG2 = "aichatagenttag2";
    public static final String FIELD_AICHATAGENTTYPE = "AICHATAGENTTYPE";
    protected static final String DTOFIELD_AICHATAGENTTYPE = "aichatagenttype";
    ...
    protected static final String DTOFIELD_PROMPTSOURCE = "promptsource";
    ...
    @JsonProperty(value="aichatagentparams")
    public void setAIChatAgentParams(String aIChatAgentParams) {
        this._set(DTOFIELD_AICHATAGENTPARAMS, aIChatAgentParams);
    }

    @JsonIgnore
    public String getAIChatAgentParams() {
        Object objValue = this._get(DTOFIELD_AICHATAGENTPARAMS);
        if (objValue == null) {
            return null;
        }
    ...
    public boolean isAIChatAgentParamsDirty() {
        return this._contains(DTOFIELD_AICHATAGENTPARAMS);
    }

    @JsonIgnore
    public void resetAIChatAgentParams() {
        this._reset(DTOFIELD_AICHATAGENTPARAMS);
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO aichatagentparams(String aIChatAgentParams) {
        this.setAIChatAgentParams(aIChatAgentParams);
        return this;
    }

    @JsonProperty(value="aichatagenttag")
    public void setAIChatAgentTag(String aIChatAgentTag) {
        this._set(DTOFIELD_AICHATAGENTTAG, aIChatAgentTag);
    }

    @JsonIgnore
    public String getAIChatAgentTag() {
        Object objValue = this._get(DTOFIELD_AICHATAGENTTAG);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isAIChatAgentTagDirty() {
        return this._contains(DTOFIELD_AICHATAGENTTAG);
    }

    @JsonIgnore
    public void resetAIChatAgentTag() {
        this._reset(DTOFIELD_AICHATAGENTTAG);
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO aichatagenttag(String aIChatAgentTag) {
        this.setAIChatAgentTag(aIChatAgentTag);
        return this;
    }

    @JsonProperty(value="aichatagenttag2")
    public void setAIChatAgentTag2(String aIChatAgentTag2) {
        this._set(DTOFIELD_AICHATAGENTTAG2, aIChatAgentTag2);
    }

    @JsonIgnore
    public String getAIChatAgentTag2() {
        Object objValue = this._get(DTOFIELD_AICHATAGENTTAG2);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isAIChatAgentTag2Dirty() {
        return this._contains(DTOFIELD_AICHATAGENTTAG2);
    }

    @JsonIgnore
    public void resetAIChatAgentTag2() {
        this._reset(DTOFIELD_AICHATAGENTTAG2);
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO aichatagenttag2(String aIChatAgentTag2) {
        this.setAIChatAgentTag2(aIChatAgentTag2);
        return this;
    }

    @JsonProperty(value="aichatagenttype")
    public void setAIChatAgentType(String aIChatAgentType) {
        this._set(DTOFIELD_AICHATAGENTTYPE, aIChatAgentType);
    }

    @JsonIgnore
    public String getAIChatAgentType() {
        Object objValue = this._get(DTOFIELD_AICHATAGENTTYPE);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isAIChatAgentTypeDirty() {
        return this._contains(DTOFIELD_AICHATAGENTTYPE);
    }

    @JsonIgnore
    public void resetAIChatAgentType() {
        this._reset(DTOFIELD_AICHATAGENTTYPE);
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO aichatagenttype(String aIChatAgentType) {
        this.setAIChatAgentType(aIChatAgentType);
        return this;
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO aichatagenttype(PSModelEnums.AIChatAgentType aIChatAgentType) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO aiplatformtype(String aIPlatformType) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO codename(String codeName) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }

    @JsonProperty(value="promptsource")
    public void setPromptSource(String promptSource) {
        this._set(DTOFIELD_PROMPTSOURCE, promptSource);
    }

    @JsonIgnore
    public String getPromptSource() {
        Object objValue = this._get(DTOFIELD_PROMPTSOURCE);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPromptSourceDirty() {
        return this._contains(DTOFIELD_PROMPTSOURCE);
    }

    @JsonIgnore
    public void resetPromptSource() {
        this._reset(DTOFIELD_PROMPTSOURCE);
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO promptsource(String promptSource) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO psdeid(String pSDEId) {
        this.setPSDEId(pSDEId);
        return this;
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO psdeid(PSDataEntityDTO pSDataEntity) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO psdename(String pSDEName) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO pssysaichatagentid(String pSSysAIChatAgentId) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO pssysaichatagentname(String pSSysAIChatAgentName) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO name(String strName) {
        this.setPSSysAIChatAgentName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO pssysaifactoryid(String pSSysAIFactoryId) {
        this.setPSSysAIFactoryId(pSSysAIFactoryId);
        return this;
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO pssysaifactoryid(PSSysAIFactoryDTO pSSysAIFactory) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO pssysaifactoryname(String pSSysAIFactoryName) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO pssyssfpluginid(String pSSysSFPluginId) {
        this.setPSSysSFPluginId(pSSysSFPluginId);
        return this;
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO pssyssfpluginid(PSSysSFPluginDTO pSSysSFPlugin) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO pssyssfpluginname(String pSSysSFPluginName) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO validflag(Integer validFlag) {
        this.setValidFlag(validFlag);
        return this;
    }

    @JsonIgnore
    public PSSysAIChatAgentDTO validflag(Boolean validFlag) {
        if (validFlag == null) {
    ...
    @JsonIgnore
    public PSSysAIChatAgentDTO id(String strValue) {
        this.setPSSysAIChatAgentId(strValue);
        return this;
    }
}
