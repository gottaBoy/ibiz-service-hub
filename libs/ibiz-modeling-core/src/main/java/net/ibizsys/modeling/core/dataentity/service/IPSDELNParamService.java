...
@Qualifier(value="PSDELNPARAM")
public interface IPSDELNParamService
extends IPSModelDEService<PSDELNParamDTO, ISearchContextDTO> {
    ...
    public Page<PSDELNParamDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDELNParamDTO> fetchListParams(ISearchContextDTO searchContext) throws Throwable;
}
