...
@Qualifier(value="PSDEMAP")
public interface IPSDEMapService
extends IPSModelDEService<PSDEMapDTO, ISearchContextDTO> {
    ...
    public Page<PSDEMapDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEMapDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEMapDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
