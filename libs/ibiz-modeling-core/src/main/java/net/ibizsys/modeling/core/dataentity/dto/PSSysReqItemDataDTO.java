...
public class PSSysReqItemDataDTO
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSSYSREQITEMDATAID = "pssysreqitemdataid";
    public static final String FIELD_PSSYSREQITEMDATANAME = "PSSYSREQITEMDATANAME";
    protected static final String DTOFIELD_PSSYSREQITEMDATANAME = "pssysreqitemdataname";
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO aibuildstate(Integer aIBuildState) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO aichoices(String aIChoices) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO aiprompt(String aIPrompt) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO content(String content) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO ordervalue(Integer orderValue) {
        this.setOrderValue(orderValue);
        return this;
    }

    @JsonProperty(value="pssysreqitemdataid")
    public void setPSSysReqItemDataId(String pSSysReqItemDataId) {
        this._set(DTOFIELD_PSSYSREQITEMDATAID, pSSysReqItemDataId);
    }

    @JsonIgnore
    public String getPSSysReqItemDataId() {
        Object objValue = this._get(DTOFIELD_PSSYSREQITEMDATAID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSysReqItemDataIdDirty() {
        return this._contains(DTOFIELD_PSSYSREQITEMDATAID);
    }

    @JsonIgnore
    public void resetPSSysReqItemDataId() {
        this._reset(DTOFIELD_PSSYSREQITEMDATAID);
    }

    @JsonIgnore
    public PSSysReqItemDataDTO pssysreqitemdataid(String pSSysReqItemDataId) {
        this.setPSSysReqItemDataId(pSSysReqItemDataId);
        return this;
    }

    @JsonProperty(value="pssysreqitemdataname")
    public void setPSSysReqItemDataName(String pSSysReqItemDataName) {
        this._set(DTOFIELD_PSSYSREQITEMDATANAME, pSSysReqItemDataName);
    }

    @JsonIgnore
    public String getPSSysReqItemDataName() {
        Object objValue = this._get(DTOFIELD_PSSYSREQITEMDATANAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSysReqItemDataNameDirty() {
        return this._contains(DTOFIELD_PSSYSREQITEMDATANAME);
    }

    @JsonIgnore
    public void resetPSSysReqItemDataName() {
        this._reset(DTOFIELD_PSSYSREQITEMDATANAME);
    }

    @JsonIgnore
    public PSSysReqItemDataDTO pssysreqitemdataname(String pSSysReqItemDataName) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO name(String strName) {
        this.setPSSysReqItemDataName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO pssysreqitemid(String pSSysReqItemId) {
        this.setPSSysReqItemId(pSSysReqItemId);
        return this;
    }

    @JsonIgnore
    public PSSysReqItemDataDTO pssysreqitemid(PSSysReqItemDTO pSSysReqItem) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO pssysreqitemname(String pSSysReqItemName) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO subject(String subject) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSSysReqItemDataDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSSysReqItemDataDTO id(String strValue) {
        this.setPSSysReqItemDataId(strValue);
        return this;
    }
}
