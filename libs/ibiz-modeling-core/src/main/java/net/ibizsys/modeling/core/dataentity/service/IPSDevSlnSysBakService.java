...
@Qualifier(value="PSDEVSLNSYSBAK")
public interface IPSDevSlnSysBakService
extends IPSModelDEService<PSDevSlnSysBakDTO, ISearchContextDTO> {
    ...
    public Page<PSDevSlnSysBakDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
