...
@Qualifier(value="PSSYSTESTDATA")
public interface IPSSysTestDataService
extends IPSModelDEService<PSSysTestDataDTO, ISearchContextDTO> {
    ...
    public Page<PSSysTestDataDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysTestDataDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysTestDataDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
