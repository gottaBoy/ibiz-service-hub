...
@Qualifier(value="PSDELOGICLINK")
public interface IPSDELogicLinkService
extends IPSModelDEService<PSDELogicLinkDTO, ISearchContextDTO> {
    ...
    public void createWithModel(PSDELogicLinkDTO dto) throws Throwable;

    public PSDELogicLinkDTO getWithModel(String value) throws Throwable;

    public void updateWithModel(PSDELogicLinkDTO dto) throws Throwable;

    public Page<PSDELogicLinkDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
