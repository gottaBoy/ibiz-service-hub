...
@Qualifier(value="PSDEMSOPPRIV")
public interface IPSDEMSOPPrivService
extends IPSModelDEService<PSDEMSOPPrivDTO, ISearchContextDTO> {
    ...
    public Page<PSDEMSOPPrivDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
