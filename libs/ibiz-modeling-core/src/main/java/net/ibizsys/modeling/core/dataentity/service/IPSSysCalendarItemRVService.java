...
@Qualifier(value="PSSYSCALENDARITEMRV")
public interface IPSSysCalendarItemRVService
extends IPSModelDEService<PSSysCalendarItemRVDTO, ISearchContextDTO> {
    ...
    public Page<PSSysCalendarItemRVDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
