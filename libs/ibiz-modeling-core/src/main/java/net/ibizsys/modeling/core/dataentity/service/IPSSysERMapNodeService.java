...
@Qualifier(value="PSSYSERMAPNODE")
public interface IPSSysERMapNodeService
extends IPSModelDEService<PSSysERMapNodeDTO, ISearchContextDTO> {
    ...
    public Page<PSSysERMapNodeDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
