...
@Qualifier(value="PSDEDBINDEX")
public interface IPSDEDBIndexService
extends IPSModelDEService<PSDEDBIndexDTO, ISearchContextDTO> {
    ...
    public Page<PSDEDBIndexDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDBIndexDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
