...
@Qualifier(value="PSVIEWMSGGRPDETAIL")
public interface IPSViewMsgGrpDetailService
extends IPSModelDEService<PSViewMsgGrpDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSViewMsgGrpDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
