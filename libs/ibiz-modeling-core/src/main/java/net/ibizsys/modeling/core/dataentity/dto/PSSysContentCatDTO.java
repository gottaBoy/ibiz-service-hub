...
public class PSSysContentCatDTO
extends PSModelDTOBase {
    public static final String FIELD_CATTAG = "CATTAG";
    protected static final String DTOFIELD_CATTAG = "cattag";
    public static final String FIELD_CATTAG2 = "CATTAG2";
    protected static final String DTOFIELD_CATTAG2 = "cattag2";
    ...
    protected static final String DTOFIELD_PPSSYSCONTENTCATID = "ppssyscontentcatid";
    public static final String FIELD_PPSSYSCONTENTCATNAME = "PPSSYSCONTENTCATNAME";
    protected static final String DTOFIELD_PPSSYSCONTENTCATNAME = "ppssyscontentcatname";
    ...
    @JsonProperty(value="cattag")
    public void setCatTag(String catTag) {
        this._set(DTOFIELD_CATTAG, catTag);
    }

    @JsonIgnore
    public String getCatTag() {
        Object objValue = this._get(DTOFIELD_CATTAG);
        if (objValue == null) {
            return null;
        }
    ...
    public boolean isCatTagDirty() {
        return this._contains(DTOFIELD_CATTAG);
    }

    @JsonIgnore
    public void resetCatTag() {
        this._reset(DTOFIELD_CATTAG);
    }
    ...
    @JsonProperty(value="cattag2")
    public void setCatTag2(String catTag2) {
        this._set(DTOFIELD_CATTAG2, catTag2);
    }

    @JsonIgnore
    public String getCatTag2() {
        Object objValue = this._get(DTOFIELD_CATTAG2);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isCatTag2Dirty() {
        return this._contains(DTOFIELD_CATTAG2);
    }

    @JsonIgnore
    public void resetCatTag2() {
        this._reset(DTOFIELD_CATTAG2);
    }
    ...
    @JsonProperty(value="ppssyscontentcatid")
    public void setPPSSysContentCatId(String pPSSysContentCatId) {
        this._set(DTOFIELD_PPSSYSCONTENTCATID, pPSSysContentCatId);
    }

    @JsonIgnore
    public String getPPSSysContentCatId() {
        Object objValue = this._get(DTOFIELD_PPSSYSCONTENTCATID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPPSSysContentCatIdDirty() {
        return this._contains(DTOFIELD_PPSSYSCONTENTCATID);
    }

    @JsonIgnore
    public void resetPPSSysContentCatId() {
        this._reset(DTOFIELD_PPSSYSCONTENTCATID);
    }
    ...
    @JsonProperty(value="ppssyscontentcatname")
    public void setPPSSysContentCatName(String pPSSysContentCatName) {
        this._set(DTOFIELD_PPSSYSCONTENTCATNAME, pPSSysContentCatName);
    }

    @JsonIgnore
    public String getPPSSysContentCatName() {
        Object objValue = this._get(DTOFIELD_PPSSYSCONTENTCATNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPPSSysContentCatNameDirty() {
        return this._contains(DTOFIELD_PPSSYSCONTENTCATNAME);
    }

    @JsonIgnore
    public void resetPPSSysContentCatName() {
        this._reset(DTOFIELD_PPSSYSCONTENTCATNAME);
    }
    ...
    @JsonIgnore
    public PSSysContentCatDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
