...
@Qualifier(value="PSSYSDBPART")
public interface IPSSysDBPartService
extends IPSModelDEService<PSSysDBPartDTO, ISearchContextDTO> {
    ...
    public static final String ACTION_CHANGEPORTLET = "CHANGEPORTLET";
    public static final String ACTION_CHECKKEY = "CHECKKEY";
    public static final String ACTION_SAVE = "SAVE";
    public static final String DATAQUERY_CURDASHBOARDROOTITEMS = "CURDASHBOARDROOTITEMS";
    public static final String DATAQUERY_DEFAULT = "DEFAULT";
    public static final String DATAQUERY_VIEW = "VIEW";
    public static final String DATASET_CURDASHBOARDROOTITEMS = "CURDASHBOARDROOTITEMS";
    public static final String DATASET_DEFAULT = "DEFAULT";

    public Page<PSSysDBPartDTO> fetchCurDashboardRootItems(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysDBPartDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
