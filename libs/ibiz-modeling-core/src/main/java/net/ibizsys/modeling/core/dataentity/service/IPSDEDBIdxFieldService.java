...
@Qualifier(value="PSDEDBIDXFIELD")
public interface IPSDEDBIdxFieldService
extends IPSModelDEService<PSDEDBIdxFieldDTO, ISearchContextDTO> {
    ...
    public Page<PSDEDBIdxFieldDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
