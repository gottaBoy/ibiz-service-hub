...
@Qualifier(value="PSDEOPPRIVROLE")
public interface IPSDEOPPrivRoleService
extends IPSModelDEService<PSDEOPPrivRoleDTO, ISearchContextDTO> {
    ...
    public Page<PSDEOPPrivRoleDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
