...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSAPPLOGICID = "psapplogicid";
    public static final String FIELD_PSAPPLOGICNAME = "PSAPPLOGICNAME";
    protected static final String DTOFIELD_PSAPPLOGICNAME = "psapplogicname";
    ...
    @JsonIgnore
    public PSAppLogicDTO dstlogictype(PSModelEnums.TargetUILogic dstLogicType) {
    ...
    public void setPSAppLogicId(String pSAppLogicId) {
        this._set(DTOFIELD_PSAPPLOGICID, pSAppLogicId);
    }

    @JsonIgnore
    public String getPSAppLogicId() {
        Object objValue = this._get(DTOFIELD_PSAPPLOGICID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSAppLogicIdDirty() {
        return this._contains(DTOFIELD_PSAPPLOGICID);
    }

    @JsonIgnore
    public void resetPSAppLogicId() {
        this._reset(DTOFIELD_PSAPPLOGICID);
    }
    ...
    public void setPSAppLogicName(String pSAppLogicName) {
        this._set(DTOFIELD_PSAPPLOGICNAME, pSAppLogicName);
    }

    @JsonIgnore
    public String getPSAppLogicName() {
        Object objValue = this._get(DTOFIELD_PSAPPLOGICNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSAppLogicNameDirty() {
        return this._contains(DTOFIELD_PSAPPLOGICNAME);
    }

    @JsonIgnore
    public void resetPSAppLogicName() {
        this._reset(DTOFIELD_PSAPPLOGICNAME);
    }
    ...
    @JsonIgnore
    public PSAppLogicDTO triggertype(PSModelEnums.AppLogicTrigger triggerType) {
        if (triggerType == null) {
    ...
    @JsonIgnore
    public PSAppLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
