...
@Qualifier(value="PSAPPINDEXVIEW")
public interface IPSAppIndexViewService
extends IPSModelDEService<PSAppIndexViewDTO, ISearchContextDTO> {
    ...
    public static final String ACTION_GETWITHOUTMENUMODEL = "GETWITHOUTMENUMODEL";
    ...
    public static final String ACTION_UPDATEWITHPANELMODEL = "UPDATEWITHPANELMODEL";
    ...
    public void switchPanelTemp(PSAppIndexViewDTO dto) throws Throwable;

    public Page<PSAppIndexViewDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppIndexViewDTO> fetchCurMod(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppIndexViewDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
