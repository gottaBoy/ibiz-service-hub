...
@Qualifier(value="PSDECHARTPARAM")
public interface IPSDEChartParamService
extends IPSModelDEService<PSDEChartParamDTO, ISearchContextDTO> {
    ...
    public Page<PSDEChartParamDTO> fetchDEFAULT(ISearchContextDTO searchContext) throws Throwable;
}
