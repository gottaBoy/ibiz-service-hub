...
@Qualifier(value="PSDEGROUPDETAIL")
public interface IPSDEGroupDetailService
extends IPSModelDEService<PSDEGroupDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSDEGroupDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
