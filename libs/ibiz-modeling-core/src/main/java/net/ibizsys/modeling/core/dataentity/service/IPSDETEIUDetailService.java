...
@Qualifier(value="PSDETEIUDETAIL")
public interface IPSDETEIUDetailService
extends IPSModelDEService<PSDETEIUDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSDETEIUDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
