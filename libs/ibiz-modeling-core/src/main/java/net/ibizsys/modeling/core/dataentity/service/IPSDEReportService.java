...
@Qualifier(value="PSDEREPORT")
public interface IPSDEReportService
extends IPSModelDEService<PSDEReportDTO, ISearchContextDTO> {
    ...
    public Page<PSDEReportDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEReportDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
