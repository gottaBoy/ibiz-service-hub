...
@Qualifier(value="PSSYSSEQUENCE")
public interface IPSSysSequenceService
extends IPSModelDEService<PSSysSequenceDTO, ISearchContextDTO> {
    ...
    public Page<PSSysSequenceDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSequenceDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
