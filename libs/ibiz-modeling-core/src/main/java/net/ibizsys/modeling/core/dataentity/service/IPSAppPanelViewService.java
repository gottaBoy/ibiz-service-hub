...
@Qualifier(value="PSAPPPANELVIEW")
public interface IPSAppPanelViewService
extends IPSModelDEService<PSAppPanelViewDTO, ISearchContextDTO> {
    ...
    public void createWithModel(PSAppPanelViewDTO dto) throws Throwable;

    public PSAppPanelViewDTO getDraftFromWithModel(PSAppPanelViewDTO dto) throws Throwable;

    public PSAppPanelViewDTO getDraftWithModel(PSAppPanelViewDTO dto) throws Throwable;

    public PSAppPanelViewDTO getWithModel(String value) throws Throwable;

    public void previewSave(PSAppPanelViewDTO dto) throws Throwable;

    public void switchPanelTemp(PSAppPanelViewDTO dto) throws Throwable;

    public void updateWithModel(PSAppPanelViewDTO dto) throws Throwable;

    public Page<PSAppPanelViewDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppPanelViewDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
