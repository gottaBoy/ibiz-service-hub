...
@Qualifier(value="PSDERGROUPDETAIL")
public interface IPSDERGroupDetailService
extends IPSModelDEService<PSDERGroupDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSDERGroupDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
