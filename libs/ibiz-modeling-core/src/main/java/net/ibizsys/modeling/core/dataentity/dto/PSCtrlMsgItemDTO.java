...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSCTRLMSGITEMID = "psctrlmsgitemid";
    public static final String FIELD_PSCTRLMSGITEMNAME = "PSCTRLMSGITEMNAME";
    protected static final String DTOFIELD_PSCTRLMSGITEMNAME = "psctrlmsgitemname";
    ...
    public void setPSCtrlMsgItemId(String pSCtrlMsgItemId) {
        this._set(DTOFIELD_PSCTRLMSGITEMID, pSCtrlMsgItemId);
    }

    @JsonIgnore
    public String getPSCtrlMsgItemId() {
        Object objValue = this._get(DTOFIELD_PSCTRLMSGITEMID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSCtrlMsgItemIdDirty() {
        return this._contains(DTOFIELD_PSCTRLMSGITEMID);
    }

    @JsonIgnore
    public void resetPSCtrlMsgItemId() {
        this._reset(DTOFIELD_PSCTRLMSGITEMID);
    }
    ...
    public void setPSCtrlMsgItemName(String pSCtrlMsgItemName) {
        this._set(DTOFIELD_PSCTRLMSGITEMNAME, pSCtrlMsgItemName);
    }

    @JsonIgnore
    public String getPSCtrlMsgItemName() {
        Object objValue = this._get(DTOFIELD_PSCTRLMSGITEMNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSCtrlMsgItemNameDirty() {
        return this._contains(DTOFIELD_PSCTRLMSGITEMNAME);
    }

    @JsonIgnore
    public void resetPSCtrlMsgItemName() {
        this._reset(DTOFIELD_PSCTRLMSGITEMNAME);
    }
    ...
    @JsonIgnore
    public PSCtrlMsgItemDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
