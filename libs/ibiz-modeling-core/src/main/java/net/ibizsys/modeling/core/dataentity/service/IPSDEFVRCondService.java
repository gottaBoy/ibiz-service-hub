...
@Qualifier(value="PSDEFVRCOND")
public interface IPSDEFVRCondService
extends IPSModelDEService<PSDEFVRCondDTO, ISearchContextDTO> {
    ...
    public Page<PSDEFVRCondDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEFVRCondDTO> fetchRoot(ISearchContextDTO searchContext) throws Throwable;
}
