...
extends PSModelDTOBase {
    ...
    public static final String DTOFIELD_PSDEFIDETAILS = "psdefiudetails";
    ...
    @JsonIgnore
    public PSDEFIUpdateDTO modelstate(Integer modelState) {
        this.setModelState(modelState);
        return this;
    }

    @JsonIgnore
    public PSDEFIUpdateDTO modelstate(PSModelEnums.DEFormDetailState[] modelState) {
    ...
    @JsonIgnore
    public List<PSDEFIUDetailDTO> getPSDEFIDetails() {
        Object list = this._get(DTOFIELD_PSDEFIDETAILS);
    ...
    public void setPSDEFIDetails(List<PSDEFIUDetailDTO> psdefiudetails) {
        this._set(DTOFIELD_PSDEFIDETAILS, psdefiudetails);
    }

    @JsonIgnore
    public List<PSDEFIUDetailDTO> getPSDEFIDetailsIf() {
        Object list = this._get(DTOFIELD_PSDEFIDETAILS);
        if (!(list instanceof List)) {
            list = new ArrayList();
            this._set(DTOFIELD_PSDEFIDETAILS, list);
        }
        return (List) list;
    }
}
