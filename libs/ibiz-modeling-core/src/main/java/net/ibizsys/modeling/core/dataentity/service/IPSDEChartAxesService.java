...
@Qualifier(value="PSDECHARTAXES")
public interface IPSDEChartAxesService
extends IPSModelDEService<PSDEChartAxesDTO, ISearchContextDTO> {
    ...
    public static final String DATAQUERY_CURXAXES = "CURXAXES";
    public static final String DATAQUERY_CURYAXES = "CURYAXES";
    ...
    public Page<PSDEChartAxesDTO> fetchCurXAxes(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEChartAxesDTO> fetchCurYAxes(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEChartAxesDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
