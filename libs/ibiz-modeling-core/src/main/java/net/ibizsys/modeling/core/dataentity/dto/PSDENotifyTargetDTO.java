...
public class PSDENotifyTargetDTO
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_FILTER = "filter";
    ...
    protected static final String DTOFIELD_PSDENOTIFYTARGETID = "psdenotifytargetid";
    public static final String FIELD_PSDENOTIFYTARGETNAME = "PSDENOTIFYTARGETNAME";
    protected static final String DTOFIELD_PSDENOTIFYTARGETNAME = "psdenotifytargetname";
    ...
    @JsonIgnore
    public PSDENotifyTargetDTO data(String data) {
        this.setData(data);
        return this;
    }
    ...
    public void setFilter(String filter) {
        this._set(DTOFIELD_FILTER, filter);
    }

    @JsonIgnore
    public String getFilter() {
        Object objValue = this._get(DTOFIELD_FILTER);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isFilterDirty() {
        return this._contains(DTOFIELD_FILTER);
    }

    @JsonIgnore
    public void resetFilter() {
        this._reset(DTOFIELD_FILTER);
    }
    ...
    public void setPSDENotifyTargetId(String pSDENotifyTargetId) {
        this._set(DTOFIELD_PSDENOTIFYTARGETID, pSDENotifyTargetId);
    }

    @JsonIgnore
    public String getPSDENotifyTargetId() {
        Object objValue = this._get(DTOFIELD_PSDENOTIFYTARGETID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDENotifyTargetIdDirty() {
        return this._contains(DTOFIELD_PSDENOTIFYTARGETID);
    }

    @JsonIgnore
    public void resetPSDENotifyTargetId() {
        this._reset(DTOFIELD_PSDENOTIFYTARGETID);
    }
    ...
    public void setPSDENotifyTargetName(String pSDENotifyTargetName) {
        this._set(DTOFIELD_PSDENOTIFYTARGETNAME, pSDENotifyTargetName);
    }

    @JsonIgnore
    public String getPSDENotifyTargetName() {
        Object objValue = this._get(DTOFIELD_PSDENOTIFYTARGETNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDENotifyTargetNameDirty() {
        return this._contains(DTOFIELD_PSDENOTIFYTARGETNAME);
    }

    @JsonIgnore
    public void resetPSDENotifyTargetName() {
        this._reset(DTOFIELD_PSDENOTIFYTARGETNAME);
    }
    ...
    @JsonIgnore
    public PSDENotifyTargetDTO targettype(PSModelEnums.DENotifyTargetType targetType) {
        if (targetType == null) {
    ...
    @JsonIgnore
    public PSDENotifyTargetDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
