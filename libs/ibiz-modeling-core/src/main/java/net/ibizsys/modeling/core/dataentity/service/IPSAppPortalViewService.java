...
@Qualifier(value="PSAPPPORTALVIEW")
public interface IPSAppPortalViewService
extends IPSModelDEService<PSAppPortalViewDTO, ISearchContextDTO> {
    ...
    public void createWithModel(PSAppPortalViewDTO dto) throws Throwable;

    public PSAppPortalViewDTO getDraftFromWithModel(PSAppPortalViewDTO dto) throws Throwable;

    public PSAppPortalViewDTO getDraftWithModel(PSAppPortalViewDTO dto) throws Throwable;

    public PSAppPortalViewDTO getWithModel(String value) throws Throwable;

    public void previewSave(PSAppPortalViewDTO dto) throws Throwable;

    public void updateWithModel(PSAppPortalViewDTO dto) throws Throwable;

    public Page<PSAppPortalViewDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppPortalViewDTO> fetchCurMod(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppPortalViewDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
