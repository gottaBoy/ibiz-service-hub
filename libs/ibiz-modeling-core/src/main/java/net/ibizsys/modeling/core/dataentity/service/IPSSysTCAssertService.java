...
@Qualifier(value="PSSYSTCASSERT")
public interface IPSSysTCAssertService
extends IPSModelDEService<PSSysTCAssertDTO, ISearchContextDTO> {
    ...
    public Page<PSSysTCAssertDTO> fetchCurTestCase(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysTCAssertDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
