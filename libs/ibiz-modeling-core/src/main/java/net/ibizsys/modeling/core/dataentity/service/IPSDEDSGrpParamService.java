...
@Qualifier(value="PSDEDSGRPPARAM")
public interface IPSDEDSGrpParamService
extends IPSModelDEService<PSDEDSGrpParamDTO, ISearchContextDTO> {
    ...
    public Page<PSDEDSGrpParamDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
