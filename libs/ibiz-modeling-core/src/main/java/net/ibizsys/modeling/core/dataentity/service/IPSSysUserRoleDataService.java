...
@Qualifier(value="PSSYSUSERROLEDATA")
public interface IPSSysUserRoleDataService
extends IPSModelDEService<PSSysUserRoleDataDTO, ISearchContextDTO> {
    ...
    public Page<PSSysUserRoleDataDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
