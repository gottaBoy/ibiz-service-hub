...
@Qualifier(value="PSSYSOPPRIV")
public interface IPSSysUserRoleService
extends IPSModelDEService<PSSysUserRoleDTO, ISearchContextDTO> {
    ...
    public Page<PSSysUserRoleDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysUserRoleDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
