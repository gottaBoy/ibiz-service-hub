...
@Qualifier(value="PSCODELIST")
public interface IPSCodeListService
extends IPSModelDEService<PSCodeListDTO, ISearchContextDTO> {
    ...
    public Page<PSCodeListDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSCodeListDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSCodeListDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
