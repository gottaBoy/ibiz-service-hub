...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSDEGRIDCOLLOGICID = "psdegridcollogicid";
    public static final String FIELD_PSDEGRIDCOLLOGICNAME = "PSDEGRIDLOGICNAME";
    protected static final String DTOFIELD_PSDEGRIDCOLLOGICNAME = "psdegridcollogicname";
    ...
    @JsonIgnore
    public PSDEGridLogicDTO attrname(String attrName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO customcode(String customCode) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO dstlogictype(String dstLogicType) {
        this.setDstLogicType(dstLogicType);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO dstlogictype(PSModelEnums.TargetUILogic dstLogicType) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO eventarg(String eventArg) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO eventarg2(String eventArg2) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO eventnames(String eventNames) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO logicparam(String logicParam) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO logicparam2(String logicParam2) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }
    ...
    @JsonIgnore
    public PSDEGridLogicDTO ordervalue(Integer orderValue) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdegridcolid(String pSDEGridColId) {
        this.setPSDEGridColId(pSDEGridColId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO psdegridcolid(PSDEGridColDTO pSDEGridCol) {
        if (pSDEGridCol == null) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdegridcolname(String pSDEGridColName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdegridid(String pSDEGridId) {
        this.setPSDEGridId(pSDEGridId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO psdegridid(PSDEGridDTO pSDEGrid) {
        if (pSDEGrid == null) {
    ...
    @JsonProperty(value="psdegridcollogicid")
    public void setPSDEGridColLogicId(String pSDEGridColLogicId) {
        this._set(DTOFIELD_PSDEGRIDCOLLOGICID, pSDEGridColLogicId);
        this._set(FIELD_PSDEGRIDCOLLOGICID, pSDEGridColLogicId);
    }

    @JsonIgnore
    public String getPSDEGridColLogicId() {
        Object objValue = this._get(DTOFIELD_PSDEGRIDCOLLOGICID);
        if (objValue == null && (objValue = this._get(FIELD_PSDEGRIDCOLLOGICID)) == null) {
            return null;
        }
        return (String)objValue;
    }
    ...
    public boolean isPSDEGridColLogicIdDirty() {
        if (this._contains(DTOFIELD_PSDEGRIDCOLLOGICID)) {
            return true;
        }
        return this._contains(FIELD_PSDEGRIDCOLLOGICID);
    }

    @JsonIgnore
    public void resetPSDEGridColLogicId() {
        this._reset(DTOFIELD_PSDEGRIDCOLLOGICID);
        this._reset(FIELD_PSDEGRIDCOLLOGICID);
    }

    @JsonIgnore
    public PSDEGridLogicDTO psdegridcollogicid(String pSDEGridColLogicId) {
        this.setPSDEGridColLogicId(pSDEGridColLogicId);
        return this;
    }

    @JsonProperty(value="psdegridcollogicname")
    public void setPSDEGridColLogicName(String pSDEGridColLogicName) {
        this._set(DTOFIELD_PSDEGRIDCOLLOGICNAME, pSDEGridColLogicName);
        this._set(FIELD_PSDEGRIDCOLLOGICNAME, pSDEGridColLogicName);
    }

    @JsonIgnore
    public String getPSDEGridColLogicName() {
        Object objValue = this._get(DTOFIELD_PSDEGRIDCOLLOGICNAME);
        if (objValue == null && (objValue = this._get(FIELD_PSDEGRIDCOLLOGICNAME)) == null) {
            return null;
        }
        return (String)objValue;
    }
    ...
    public boolean isPSDEGridColLogicNameDirty() {
        if (this._contains(DTOFIELD_PSDEGRIDCOLLOGICNAME)) {
            return true;
        }
        return this._contains(FIELD_PSDEGRIDCOLLOGICNAME);
    }

    @JsonIgnore
    public void resetPSDEGridColLogicName() {
        this._reset(DTOFIELD_PSDEGRIDCOLLOGICNAME);
        this._reset(FIELD_PSDEGRIDCOLLOGICNAME);
    }

    @JsonIgnore
    public PSDEGridLogicDTO psdegridcollogicname(String pSDEGridColLogicName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO name(String strName) {
        this.setPSDEGridColLogicName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdegridname(String pSDEGridName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdeid(String pSDEId) {
        this.setPSDEId(pSDEId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO psdeid(PSDataEntityDTO pSDataEntity) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdelogicid(String pSDELogicId) {
        this.setPSDELogicId(pSDELogicId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO psdelogicid(PSDELogicDTO pSDELogic) {
        if (pSDELogic == null) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdelogicname(String pSDELogicName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdename(String pSDEName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdeuiactionid(String pSDEUIActionId) {
        this.setPSDEUIActionId(pSDEUIActionId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO psdeuiactionid(PSDEUIActionDTO pSDEUIAction) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO psdeuiactionname(String pSDEUIActionName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO pssyspfpluginid(String pSSysPFPluginId) {
        this.setPSSysPFPluginId(pSSysPFPluginId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO pssyspfpluginid(PSSysPFPluginDTO pSSysPFPlugin) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO pssyspfpluginname(String pSSysPFPluginName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO pssysviewlogicid(String pSSysViewLogicId) {
        this.setPSSysViewLogicId(pSSysViewLogicId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO pssysviewlogicid(PSSysViewLogicDTO pSSysViewLogic) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO pssysviewlogicname(String pSSysViewLogicName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO pssysviewpanelid(String pSSysViewPanelId) {
        this.setPSSysViewPanelId(pSSysViewPanelId);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO pssysviewpanelid(PSSysViewPanelDTO pSSysViewPanel) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO pssysviewpanelname(String pSSysViewPanelName) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO timer(Integer timer) {
        this.setTimer(timer);
        return this;
    }
    ...
    @JsonIgnore
    public PSDEGridLogicDTO triggertype(String triggerType) {
        this.setTriggerType(triggerType);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO triggertype(PSModelEnums.ViewLogicTrigger triggerType) {
        if (triggerType == null) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO validflag(Integer validFlag) {
        this.setValidFlag(validFlag);
        return this;
    }

    @JsonIgnore
    public PSDEGridLogicDTO validflag(Boolean validFlag) {
        if (validFlag == null) {
    ...
    @JsonIgnore
    public PSDEGridLogicDTO id(String strValue) {
        this.setPSDEGridColLogicId(strValue);
        return this;
    }
}
