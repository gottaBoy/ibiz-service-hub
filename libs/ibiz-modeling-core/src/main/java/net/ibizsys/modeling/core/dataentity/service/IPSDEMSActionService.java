...
@Qualifier(value="PSDEMSACTION")
public interface IPSDEMSActionService
extends IPSModelDEService<PSDEMSActionDTO, ISearchContextDTO> {
    ...
    public Page<PSDEMSActionDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
