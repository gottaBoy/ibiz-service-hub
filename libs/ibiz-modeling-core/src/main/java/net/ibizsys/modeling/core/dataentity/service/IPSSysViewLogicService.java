...
@Qualifier(value="PSSYSVIEWLOGIC")
public interface IPSSysViewLogicService
extends IPSModelDEService<PSSysViewLogicDTO, ISearchContextDTO> {
    ...
    public Page<PSSysViewLogicDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewLogicDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysViewLogicDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
