...
@Qualifier(value="PSSYSSEARCHBARITEM")
public interface IPSSysSearchBarItemService
extends IPSModelDEService<PSSysSearchBarItemDTO, ISearchContextDTO> {
    ...
    public static final String DATAQUERY_FILTER = "FILTER";
    public static final String DATAQUERY_GROUP = "GROUP";
    public static final String DATAQUERY_QUICKSEARCH = "QUICKSEARCH";
    ...
    public Page<PSSysSearchBarItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSearchBarItemDTO> fetchFilter(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSearchBarItemDTO> fetchFormType(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSearchBarItemDTO> fetchGroup(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysSearchBarItemDTO> fetchQuickSearch(ISearchContextDTO searchContext) throws Throwable;
}
