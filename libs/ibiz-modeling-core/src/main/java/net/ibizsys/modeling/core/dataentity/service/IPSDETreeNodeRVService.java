...
@Qualifier(value="PSDETREENODERV")
public interface IPSDETreeNodeRVService
extends IPSModelDEService<PSDETreeNodeRVDTO, ISearchContextDTO> {
    ...
    public Page<PSDETreeNodeRVDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
