...
@Qualifier(value="PSDEMAPDQ")
public interface IPSDEMapDQService
extends IPSModelDEService<PSDEMapDQDTO, ISearchContextDTO> {
    ...
    public Page<PSDEMapDQDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
