...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSDELISTLOGICID = "psdelistlogicid";
    public static final String FIELD_PSDELISTLOGICNAME = "PSDELISTLOGICNAME";
    protected static final String DTOFIELD_PSDELISTLOGICNAME = "psdelistlogicname";
    ...
    @JsonIgnore
    public PSDEListLogicDTO dstlogictype(PSModelEnums.TargetUILogic dstLogicType) {
    ...
    @JsonProperty(value="psdelistlogicid")
    public void setPSDEListLogicId(String pSDEListLogicId) {
        this._set(DTOFIELD_PSDELISTLOGICID, pSDEListLogicId);
    }

    @JsonIgnore
    public String getPSDEListLogicId() {
        Object objValue = this._get(DTOFIELD_PSDELISTLOGICID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEListLogicIdDirty() {
        return this._contains(DTOFIELD_PSDELISTLOGICID);
    }

    @JsonIgnore
    public void resetPSDEListLogicId() {
        this._reset(DTOFIELD_PSDELISTLOGICID);
    }
    ...
    @JsonProperty(value="psdelistlogicname")
    public void setPSDEListLogicName(String pSDEListLogicName) {
        this._set(DTOFIELD_PSDELISTLOGICNAME, pSDEListLogicName);
    }

    @JsonIgnore
    public String getPSDEListLogicName() {
        Object objValue = this._get(DTOFIELD_PSDELISTLOGICNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEListLogicNameDirty() {
        return this._contains(DTOFIELD_PSDELISTLOGICNAME);
    }

    @JsonIgnore
    public void resetPSDEListLogicName() {
        this._reset(DTOFIELD_PSDELISTLOGICNAME);
    }
    ...
    @JsonIgnore
    public PSDEListLogicDTO triggertype(PSModelEnums.ViewLogicTrigger triggerType) {
        if (triggerType == null) {
    ...
    @JsonIgnore
    public PSDEListLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
