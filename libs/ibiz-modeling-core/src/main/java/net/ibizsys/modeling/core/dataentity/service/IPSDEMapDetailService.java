...
@Qualifier(value="PSDEMAPDETAIL")
public interface IPSDEMapDetailService
extends IPSModelDEService<PSDEMapDetailDTO, ISearchContextDTO> {
    ...
    public Page<PSDEMapDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
