...
public class PSSysChartThemeDTO
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_THEMETAG2 = "themetag2";
    ...
    @JsonProperty(value="themetag2")
    public void setThemeTag2(String themeTag2) {
        this._set(DTOFIELD_THEMETAG2, themeTag2);
    }

    @JsonIgnore
    public String getThemeTag2() {
        Object objValue = this._get(DTOFIELD_THEMETAG2);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isThemeTag2Dirty() {
        return this._contains(DTOFIELD_THEMETAG2);
    }

    @JsonIgnore
    public void resetThemeTag2() {
        this._reset(DTOFIELD_THEMETAG2);
    }
    ...
    @JsonIgnore
    public PSSysChartThemeDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
