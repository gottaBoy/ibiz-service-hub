...
@Qualifier(value="PSDEDATAIMP")
public interface IPSDEDataImpService
extends IPSModelDEService<PSDEDataImpDTO, ISearchContextDTO> {
    ...
    public Page<PSDEDataImpDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDataImpDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEDataImpDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
