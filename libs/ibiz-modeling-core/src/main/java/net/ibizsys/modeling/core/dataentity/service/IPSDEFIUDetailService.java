...
@Qualifier(value="PSDEFIUDETAIL")
public interface IPSDEFIUDetailService
extends IPSModelDEService<PSDEFIUDetailDTO, ISearchContextDTO> {
    ...
    public static final String DATAQUERY_CURFIU = "CURFIU";
    public static final String DATAQUERY_VIEW = "VIEW";
    public static final String DATASET_CURFIU = "CURFIU";
    public static final String DATASET_DEFAULT = "DEFAULT";

    public Page<PSDEFIUDetailDTO> fetchCurFIU(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEFIUDetailDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
