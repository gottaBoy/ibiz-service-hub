...
@Qualifier(value="PSDEUSERROLE")
public interface IPSDEUserRoleService
extends IPSModelDEService<PSDEUserRoleDTO, ISearchContextDTO> {
    ...
    public Page<PSDEUserRoleDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEUserRoleDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEUserRoleDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
