...
extends PSModelDTOBase {
    ...
    public void setCatCode(String catCode) {
        this._set(DTOFIELD_CATCODE, catCode);
    }

    @JsonIgnore
    public String getCatCode() {
        Object objValue = this._get(DTOFIELD_CATCODE);
        if (objValue == null) {
            return null;
        }
    ...
    public boolean isCatCodeDirty() {
        return this._contains(DTOFIELD_CATCODE);
    }

    @JsonIgnore
    public void resetCatCode() {
        this._reset(DTOFIELD_CATCODE);
    }

    @JsonIgnore
    public PSSysWFCatDTO catcode(String catCode) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO createdate(Timestamp createDate) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO createman(String createMan) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO memo(String memo) {
        this.setMemo(memo);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysWFCatDTO ordervalue(Integer orderValue) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO psmoduleid(String pSModuleId) {
        this.setPSModuleId(pSModuleId);
        return this;
    }

    @JsonIgnore
    public PSSysWFCatDTO psmoduleid(PSModuleDTO pSModule) {
        if (pSModule == null) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO psmodulename(String pSModuleName) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO pssyswfcatid(String pSSysWFCatId) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO pssyswfcatname(String pSSysWFCatName) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO name(String strName) {
        this.setPSSysWFCatName(strName);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysWFCatDTO updatedate(Timestamp updateDate) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO updateman(String updateMan) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO usercat(String userCat) {
        this.setUserCat(userCat);
        return this;
    }

    @JsonIgnore
    public PSSysWFCatDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO usertag(String userTag) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO usertag2(String userTag2) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO usertag3(String userTag3) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO usertag4(String userTag4) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO validflag(Integer validFlag) {
        this.setValidFlag(validFlag);
        return this;
    }

    @JsonIgnore
    public PSSysWFCatDTO validflag(Boolean validFlag) {
        if (validFlag == null) {
    ...
    @JsonIgnore
    public PSSysWFCatDTO id(String strValue) {
        this.setPSSysWFCatId(strValue);
        return this;
    }
}
