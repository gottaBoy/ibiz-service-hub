...
public class PSSysViewLogicDTO
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_CUSTOMSTYLE = "customstyle";
    public static final String FIELD_LOGICPSDEID = "LOGICPSDEID";
    protected static final String DTOFIELD_LOGICPSDEID = "logicpsdeid";
    ...
    protected static final String DTOFIELD_PSVIEWLOGICTYPEID = "psviewlogictypeid";
    public static final String FIELD_PSVIEWLOGICTYPENAME = "PSVIEWLOGICTYPENAME";
    protected static final String DTOFIELD_PSVIEWLOGICTYPENAME = "psviewlogictypename";
    ...
    public static final String DTOFIELD_PSSYSVIEWLOGICPARAMS = "pssysviewlogicparams";
    ...
    @JsonProperty(value="customstyle")
    public void setCustomStyle(String customStyle) {
        this._set(DTOFIELD_CUSTOMSTYLE, customStyle);
    }

    @JsonIgnore
    public String getCustomStyle() {
        Object objValue = this._get(DTOFIELD_CUSTOMSTYLE);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isCustomStyleDirty() {
        return this._contains(DTOFIELD_CUSTOMSTYLE);
    }

    @JsonIgnore
    public void resetCustomStyle() {
        this._reset(DTOFIELD_CUSTOMSTYLE);
    }
    ...
    @JsonProperty(value="logicpsdeid")
    public void setLogicPSDEId(String logicPSDEId) {
        this._set(DTOFIELD_LOGICPSDEID, logicPSDEId);
    }

    @JsonIgnore
    public String getLogicPSDEId() {
        Object objValue = this._get(DTOFIELD_LOGICPSDEID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isLogicPSDEIdDirty() {
        return this._contains(DTOFIELD_LOGICPSDEID);
    }

    @JsonIgnore
    public void resetLogicPSDEId() {
        this._reset(DTOFIELD_LOGICPSDEID);
    }
    ...
    @JsonIgnore
    public PSSysViewLogicDTO logictype(PSModelEnums.UILogicType logicType) {
        if (logicType == null) {
    ...
    @JsonProperty(value="psviewlogictypeid")
    public void setPSViewLogicTypeId(String pSViewLogicTypeId) {
        this._set(DTOFIELD_PSVIEWLOGICTYPEID, pSViewLogicTypeId);
    }

    @JsonIgnore
    public String getPSViewLogicTypeId() {
        Object objValue = this._get(DTOFIELD_PSVIEWLOGICTYPEID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSViewLogicTypeIdDirty() {
        return this._contains(DTOFIELD_PSVIEWLOGICTYPEID);
    }

    @JsonIgnore
    public void resetPSViewLogicTypeId() {
        this._reset(DTOFIELD_PSVIEWLOGICTYPEID);
    }
    ...
    @JsonProperty(value="psviewlogictypename")
    public void setPSViewLogicTypeName(String pSViewLogicTypeName) {
        this._set(DTOFIELD_PSVIEWLOGICTYPENAME, pSViewLogicTypeName);
    }

    @JsonIgnore
    public String getPSViewLogicTypeName() {
        Object objValue = this._get(DTOFIELD_PSVIEWLOGICTYPENAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSViewLogicTypeNameDirty() {
        return this._contains(DTOFIELD_PSVIEWLOGICTYPENAME);
    }

    @JsonIgnore
    public void resetPSViewLogicTypeName() {
        this._reset(DTOFIELD_PSVIEWLOGICTYPENAME);
    }
    ...
    @JsonIgnore
    public PSSysViewLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
    ...
    @JsonIgnore
    public List<PSSysViewLogicParamDTO> getPSSysViewLogicParams() {
        Object list = this._get(DTOFIELD_PSSYSVIEWLOGICPARAMS);
    ...
    @JsonProperty(value="pssysviewlogicparams")
    public void setPSSysViewLogicParams(List<PSSysViewLogicParamDTO> pssysviewlogicparams) {
        this._set(DTOFIELD_PSSYSVIEWLOGICPARAMS, pssysviewlogicparams);
    }

    @JsonIgnore
    public List<PSSysViewLogicParamDTO> getPSSysViewLogicParamsIf() {
        Object list = this._get(DTOFIELD_PSSYSVIEWLOGICPARAMS);
        if (!(list instanceof List)) {
            list = new ArrayList();
            this._set(DTOFIELD_PSSYSVIEWLOGICPARAMS, list);
        }
        return (List)list;
    }
}
