...
@Qualifier(value="PSSUBSYSSADERS")
public interface IPSSubSysSADERSService
extends IPSModelDEService<PSSubSysSADERSDTO, ISearchContextDTO> {
    ...
    public Page<PSSubSysSADERSDTO> fetchCurSA(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSubSysSADERSDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
