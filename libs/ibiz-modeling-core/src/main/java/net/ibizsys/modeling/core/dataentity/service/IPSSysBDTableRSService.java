...
@Qualifier(value="PSSYSBDTABLERS")
public interface IPSSysBDTableRSService
extends IPSModelDEService<PSSysBDTableRSDTO, ISearchContextDTO> {
    ...
    public Page<PSSysBDTableRSDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
