...
@Qualifier(value="PSDETREENODERS")
public interface IPSDETreeNodeRSService
extends IPSModelDEService<PSDETreeNodeRSDTO, ISearchContextDTO> {
    ...
    public Page<PSDETreeNodeRSDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
