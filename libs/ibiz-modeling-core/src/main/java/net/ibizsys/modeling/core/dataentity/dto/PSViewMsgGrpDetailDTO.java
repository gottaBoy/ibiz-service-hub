...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSVIEWMSGGRPDETAILID = "psviewmsggrpdetailid";
    ...
    @JsonIgnore
    public PSViewMsgGrpDetailDTO enablemode(String enableMode) {
        this.setEnableMode(enableMode);
        return this;
    }

    @JsonIgnore
    public PSViewMsgGrpDetailDTO enablemode(PSModelEnums.ViewMsgEnableMode enableMode) {
        if (enableMode == null) {
    ...
    @JsonIgnore
    public PSViewMsgGrpDetailDTO msgpos(PSModelEnums.ViewMsgPos msgPos) {
        if (msgPos == null) {
            this.setMsgPos(null);
        } else {
    ...
    public void setPSViewMsgGrpDetailId(String pSViewMsgGrpDetailId) {
        this._set(DTOFIELD_PSVIEWMSGGRPDETAILID, pSViewMsgGrpDetailId);
    }

    @JsonIgnore
    public String getPSViewMsgGrpDetailId() {
        Object objValue = this._get(DTOFIELD_PSVIEWMSGGRPDETAILID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSViewMsgGrpDetailIdDirty() {
        return this._contains(DTOFIELD_PSVIEWMSGGRPDETAILID);
    }

    @JsonIgnore
    public void resetPSViewMsgGrpDetailId() {
        this._reset(DTOFIELD_PSVIEWMSGGRPDETAILID);
    }
    ...
    @JsonIgnore
    public PSViewMsgGrpDetailDTO testcustomcode(String testCustomCode) {
    ...
    @JsonIgnore
    public PSViewMsgGrpDetailDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
