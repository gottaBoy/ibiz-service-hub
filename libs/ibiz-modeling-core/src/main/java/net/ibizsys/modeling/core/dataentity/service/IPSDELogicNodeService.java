...
@Qualifier(value="PSDELOGICNODE")
public interface IPSDELogicNodeService
extends IPSModelDEService<PSDELogicNodeDTO, ISearchContextDTO> {
    ...
    public static final String ACTION_CALCPARAMDE = "CALCPARAMDE";
    public static final String ACTION_CALCSRCPARAMDE = "CALCSRCPARAMDE";
    ...
    public Page<PSDELogicNodeDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDELogicNodeDTO> fetchFormType(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDELogicNodeDTO> fetchULFormType(ISearchContextDTO searchContext) throws Throwable;
}
