...
@Qualifier(value="PSWFLINKROLE")
public interface IPSWFLinkRoleService
extends IPSModelDEService<PSWFLinkRoleDTO, ISearchContextDTO> {
    ...
    public Page<PSWFLinkRoleDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
