...
@Qualifier(value="PSDEMAPACTION")
public interface IPSDEMapActionService
extends IPSModelDEService<PSDEMapActionDTO, ISearchContextDTO> {
    ...
    public Page<PSDEMapActionDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
