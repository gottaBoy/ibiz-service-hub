...
@Qualifier(value="PSSYSBICUBEMEASURE")
public interface IPSSysBICubeMeasureService
extends IPSModelDEService<PSSysBICubeMeasureDTO, ISearchContextDTO> {
    ...
    public Page<PSSysBICubeMeasureDTO> fetchCurCube(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysBICubeMeasureDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
