...
@Qualifier(value="PSAPPVIEW")
public interface IPSAppViewService
extends IPSModelDEService<PSAppViewDTO, ISearchContextDTO> {
    ...
    public Page<PSAppViewDTO> fetchCurApp(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppViewDTO> fetchCurMod(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppViewDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppViewDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSAppViewDTO> fetchIndexDE(ISearchContextDTO searchContext) throws Throwable;
}
