...
@Qualifier(value="PSSYSTDITEM")
public interface IPSSysTDItemService
extends IPSModelDEService<PSSysTDItemDTO, ISearchContextDTO> {
    ...
    public void initDataItems(PSSysTDItemDTO dto) throws Throwable;

    public Page<PSSysTDItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
