 ...
 *  net.ibizsys.model.PSModelEnums$TargetUILogic
 *  net.ibizsys.model.PSModelEnums$ViewLogicTrigger
 */
...
public class PSDEDataViewLogicDTO
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSDEDATAVIEWLOGICID = "psdedataviewlogicid";
    public static final String FIELD_PSDEDATAVIEWLOGICNAME = "PSDEDATAVIEWLOGICNAME";
    protected static final String DTOFIELD_PSDEDATAVIEWLOGICNAME = "psdedataviewlogicname";
    ...
    @JsonIgnore
    public PSDEDataViewLogicDTO dstlogictype(PSModelEnums.TargetUILogic dstLogicType) {
    ...
    @JsonProperty(value="psdedataviewlogicid")
    public void setPSDEDataViewLogicId(String pSDEDataViewLogicId) {
        this._set(DTOFIELD_PSDEDATAVIEWLOGICID, pSDEDataViewLogicId);
    }

    @JsonIgnore
    public String getPSDEDataViewLogicId() {
        Object objValue = this._get(DTOFIELD_PSDEDATAVIEWLOGICID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEDataViewLogicIdDirty() {
        return this._contains(DTOFIELD_PSDEDATAVIEWLOGICID);
    }

    @JsonIgnore
    public void resetPSDEDataViewLogicId() {
        this._reset(DTOFIELD_PSDEDATAVIEWLOGICID);
    }
    ...
    @JsonProperty(value="psdedataviewlogicname")
    public void setPSDEDataViewLogicName(String pSDEDataViewLogicName) {
        this._set(DTOFIELD_PSDEDATAVIEWLOGICNAME, pSDEDataViewLogicName);
    }

    @JsonIgnore
    public String getPSDEDataViewLogicName() {
        Object objValue = this._get(DTOFIELD_PSDEDATAVIEWLOGICNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEDataViewLogicNameDirty() {
        return this._contains(DTOFIELD_PSDEDATAVIEWLOGICNAME);
    }

    @JsonIgnore
    public void resetPSDEDataViewLogicName() {
        this._reset(DTOFIELD_PSDEDATAVIEWLOGICNAME);
    }
    ...
    @JsonIgnore
    public PSDEDataViewLogicDTO triggertype(PSModelEnums.ViewLogicTrigger triggerType) {
        if (triggerType == null) {
    ...
    @JsonIgnore
    public PSDEDataViewLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
