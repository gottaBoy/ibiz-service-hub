...
extends PSModelDTOBase {
    ...
    protected static final String DTOFIELD_PSDEFORMLOGICID = "psdeformlogicid";
    public static final String FIELD_PSDEFORMLOGICNAME = "PSDEFORMLOGICNAME";
    protected static final String DTOFIELD_PSDEFORMLOGICNAME = "psdeformlogicname";
    ...
    @JsonIgnore
    public PSDEFormLogicDTO dstlogictype(PSModelEnums.TargetUILogic dstLogicType) {
    ...
    @JsonProperty(value="psdeformlogicid")
    public void setPSDEFormLogicId(String pSDEFormLogicId) {
        this._set(DTOFIELD_PSDEFORMLOGICID, pSDEFormLogicId);
    }

    @JsonIgnore
    public String getPSDEFormLogicId() {
        Object objValue = this._get(DTOFIELD_PSDEFORMLOGICID);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEFormLogicIdDirty() {
        return this._contains(DTOFIELD_PSDEFORMLOGICID);
    }

    @JsonIgnore
    public void resetPSDEFormLogicId() {
        this._reset(DTOFIELD_PSDEFORMLOGICID);
    }
    ...
    @JsonProperty(value="psdeformlogicname")
    public void setPSDEFormLogicName(String pSDEFormLogicName) {
        this._set(DTOFIELD_PSDEFORMLOGICNAME, pSDEFormLogicName);
    }

    @JsonIgnore
    public String getPSDEFormLogicName() {
        Object objValue = this._get(DTOFIELD_PSDEFORMLOGICNAME);
        if (objValue == null) {
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEFormLogicNameDirty() {
        return this._contains(DTOFIELD_PSDEFORMLOGICNAME);
    }

    @JsonIgnore
    public void resetPSDEFormLogicName() {
        this._reset(DTOFIELD_PSDEFORMLOGICNAME);
    }
    ...
    @JsonIgnore
    public PSDEFormLogicDTO triggertype(PSModelEnums.ViewLogicTrigger triggerType) {
        if (triggerType == null) {
    ...
    @JsonIgnore
    public PSDEFormLogicDTO usercat(PSModelEnums.ModelUserCat userCat) {
        if (userCat == null) {
