...
@Qualifier(value="PSDEGEIVR")
public interface IPSDEGEIVRService
extends IPSModelDEService<PSDEGEIVRDTO, ISearchContextDTO> {
    ...
    public Page<PSDEGEIVRDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
