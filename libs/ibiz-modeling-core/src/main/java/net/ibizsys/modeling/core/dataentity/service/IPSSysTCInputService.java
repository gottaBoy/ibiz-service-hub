...
@Qualifier(value="PSSYSTCINPUT")
public interface IPSSysTCInputService
extends IPSModelDEService<PSSysTCInputDTO, ISearchContextDTO> {
    ...
    public Page<PSSysTCInputDTO> fetchCurTestCase(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSSysTCInputDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
