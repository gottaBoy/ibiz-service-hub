...
@Qualifier(value="PSDEGROUP")
public interface IPSDEGroupService
extends IPSModelDEService<PSDEGroupDTO, ISearchContextDTO> {
    ...
    @Override
    public void initModel(PSDEGroupDTO dto) throws Throwable;

    public Page<PSDEGroupDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEGroupDTO> fetchCurMod(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEGroupDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEGroupDTO> fetchCurSys2(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEGroupDTO> fetchCurSysAll(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSDEGroupDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
