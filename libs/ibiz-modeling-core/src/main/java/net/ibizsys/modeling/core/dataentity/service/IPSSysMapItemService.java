...
@Qualifier(value="PSSYSMAPITEM")
public interface IPSSysMapItemService
extends IPSModelDEService<PSSysMapItemDTO, ISearchContextDTO> {
    ...
    public Page<PSSysMapItemDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
