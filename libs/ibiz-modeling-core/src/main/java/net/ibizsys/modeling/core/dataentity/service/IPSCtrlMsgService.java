...
@Qualifier(value="PSCTRLMSG")
public interface IPSCtrlMsgService
extends IPSModelDEService<PSCtrlMsgDTO, ISearchContextDTO> {
    ...
    public Page<PSCtrlMsgDTO> fetchCurDE(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSCtrlMsgDTO> fetchCurDEAll(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSCtrlMsgDTO> fetchCurSys(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSCtrlMsgDTO> fetchCurSysAll(ISearchContextDTO searchContext) throws Throwable;

    public Page<PSCtrlMsgDTO> fetchDefault(ISearchContextDTO searchContext) throws Throwable;
}
