...
public final class McpSchema {
	...
	public interface Request{
		...
		/**
		 * Returns transport headers that must not be serialized into the MCP payload.
		 */
		@JsonIgnore
...
//	}
		/**
		 * Tool request with optional out-of-band transport headers.
		 *
		 * <p>The cloud MCP agent uses the {@code io.modelcontextprotocol} client
		 * implementation, so this request deliberately remains a subtype of that
		 * implementation's request class while carrying the local transport metadata.
		 */
		public final static class CallToolRequest extends io.modelcontextprotocol.spec.McpSchema.CallToolRequest
		        implements Request {
	    private final String name;
	    private final Map<String, Object> arguments;
	    private final Map<String, Object> meta;
	    ...
	    /**
	     * Creates a tool request with optional MCP metadata and out-of-band transport
	     * headers. Headers are intentionally excluded from the serialized MCP payload.
	     */
		    public CallToolRequest(
		        String name,
	    ...
	    @Override
	    public int hashCode() {
	        return Objects.hash(name, arguments, meta, headers);
	    }
